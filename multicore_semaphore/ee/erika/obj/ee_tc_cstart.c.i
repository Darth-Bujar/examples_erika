#line 1 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_cstart.c"
/* ###*B*###
...
#line 79 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_cstart.c"
...
#line 80 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_cstart.c"
...
void _START(void)
{
  ...
  __asm volatile ("ja " "osEE_tc_core0_start");
}
...
extern __far OsEE_stack _lc_ue_ustack_tc0[];
extern __far OsEE_stack _lc_ue_istack_tc0[];

extern void _lc_u_trap_tab_tc0(void);
extern void _lc_u_int_tab_tc0(void);

extern __far uint8_t _SMALL_DATA_[];
extern __far uint8_t _LITERAL_DATA_[];
extern __far uint8_t _A8_DATA_[];
extern __far uint8_t _A9_DATA_[];

extern __far OsEE_csa _lc_ub_csa_tc0[];
extern __far OsEE_csa _lc_ue_csa_tc0[];
...
/* Set the PSW to its reset value in case of a warm start, set PSW.IS.
   ...
   current TASK */
  (__mtcr((0xFE04U), (0x00000BFFU)));

/* Set the PCXS and PCXO to its reset value in case of a warm start */
  pcxi  = ((OsEE_reg)__mfcr((0xFE00U)));
  pcxi &= 0xFFF00000U;
  (__mtcr((0xFE00U), pcxi));
...
/* TODO: Enable/Disable program cache depending on the configuration */
  osEE_tc_set_pcache_wo_endinit(OSEE_TRUE);

/* TODO: Enable/Disable data cache depending on the configuration */
  osEE_tc_set_dcache_wo_endinit(OSEE_TRUE);

/* Load Base Address of Trap Vector Table. */
  (__mtcr((0xFE24U), (OsEE_reg)_lc_u_trap_tab_tc0));

/* Load Base Address of Interrupt Vector Table. */
  (__mtcr((0xFE20U), (OsEE_reg)_lc_u_int_tab_tc0));

/* Load Interrupt Stack Pointer. (Not Used) */
  (__mtcr((0xFE28U), (OsEE_reg)_lc_ue_istack_tc0));

/* Set the ENDINIT bit in the WDT_CON0 register back */
  osEE_tc_set_cpu_endinit(0U, cpu_wdt_pw);

/* Initialize SDA base pointers */
  __asm volatile ("mov.aa " "a0" ", %0": : "a"(_SMALL_DATA_): "memory", "a0");
  __asm volatile ("mov.aa " "a1" ", %0": : "a"(_LITERAL_DATA_): "memory", "a1");

/* Initialization of A8 and A9 */
  __asm volatile ("mov.aa " "a8" ", %0": : "a"(_A8_DATA_): "memory", "a8");



  __asm volatile ("mov.aa " "a9" ", %0": : "a"(&osEE_cdb_var_core0): "memory", "a9");


/* Setup the context save area linked list for CPU0 */
  osEE_tc_csa_init_inline(_lc_ub_csa_tc0, _lc_ue_csa_tc0);
...
/* Linker script defined symbols */
extern __far OsEE_stack _lc_ue_ustack_tc1[];
extern __far OsEE_stack _lc_ue_istack_tc1[];

extern void _lc_u_trap_tab_tc1(void);
extern void _lc_u_int_tab_tc1(void);

extern __far OsEE_csa _lc_ub_csa_tc1[];
extern __far OsEE_csa _lc_ue_csa_tc1[];
...
/* Load Base Address of Trap Vector Table. */
  (__mtcr((0xFE24U), (OsEE_reg)_lc_u_trap_tab_tc1));

/* Load Base Address of Interrupt Vector Table. */
  (__mtcr((0xFE20U), (OsEE_reg)_lc_u_int_tab_tc1));

/* Load Interrupt Stack Pointer. (Not Used) */
  (__mtcr((0xFE28U), (OsEE_reg)_lc_ue_istack_tc1));
...
/* Initialization of A8 and A9 */
  ...
  __asm volatile ("mov.aa " "a9" ", %0": : "a"(&osEE_cdb_var_core1): "memory", "a9");


/* Setup the context save area linked list for CPU0 */
  osEE_tc_csa_init_inline(_lc_ub_csa_tc1, _lc_ue_csa_tc1);
...
/* Linker script defined symbols */
extern __far OsEE_stack _lc_ue_ustack_tc2[];
extern __far OsEE_stack _lc_ue_istack_tc2[];

extern void _lc_u_trap_tab_tc2(void);
extern void _lc_u_int_tab_tc2(void);

extern __far OsEE_csa _lc_ub_csa_tc2[];
extern __far OsEE_csa _lc_ue_csa_tc2[];
...
/* Load Base Address of Trap Vector Table. */
  (__mtcr((0xFE24U), (OsEE_reg)_lc_u_trap_tab_tc2));

/* Load Base Address of Interrupt Vector Table. */
  (__mtcr((0xFE20U), (OsEE_reg)_lc_u_int_tab_tc2));

/* Load Interrupt Stack Pointer. (Not Used) */
  (__mtcr((0xFE28U), (OsEE_reg)_lc_ue_istack_tc2));
...
/* Initialization of A8 and A9 */
  ...
  __asm volatile ("mov.aa " "a9" ", %0": : "a"(&osEE_cdb_var_core2): "memory", "a9");


/* Setup the context save area linked list for CPU0 */
  osEE_tc_csa_init_inline(_lc_ub_csa_tc2, _lc_ue_csa_tc2);
