#line 1 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_ctx.c"
/* ###*B*###
...
#line 54 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_ctx.c"
...
/* Jump to the restore CTX */
  __asm volatile ("j " "osEE_hal_restore_ctx");
...
/* Jump to Kernel Wrapper: it will be the "ret" inside
   ...
   2) Return at RA address, that is the address after change context calling
      site */
  __asm volatile ("j " "osEE_scheduler_task_wrapper_restore");
...
/* Jump to the ready to stacked */
  __asm volatile ("j " "osEE_hal_ready2stacked");
/* Touch implicitly used parameters to turn off warnings */
  (void)p_to_tdb;
  (void)p_to_scb;
}
...
/* Jump to Kernel Wrapper */
  __asm volatile ("j " "osEE_scheduler_task_wrapper_run");
/* Touch implicitly used parameter to turn off warnings */
  (void)p_to_tdb;
}
...
/* Prepare to jump to osEE_tc_change_context_from_task_end */
      __asm volatile ("mov.aa " "a4" ", %0": : "a"(p_to): "memory", "a4");
      __asm volatile ("j " "osEE_tc_change_context_from_task_end");
    }
  }
...
#line 287 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_ctx.c"

#line 287 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_tc_ctx.c"
(__mtcr((0xFE04U), ((OsEE_reg)__mfcr((0xFE04U))) & (0xFFFFFF80U)));
...
)
{
  ...
  if (p_to_tcb->status == OSEE_TASK_READY_STACKED) {
    __asm volatile ("mov.aa " "a4" ", %0": : "a"(p_to): "memory", "a4");
    __asm volatile ("mov.aa " "a5" ", %0": : "a"(p_to->hdb.p_scb): "memory", "a5");
    __asm volatile ("j " "osEE_hal_restore_ctx");
  } else {
    __asm volatile ("mov.aa " "a4" ", %0": : "a"(p_to): "memory", "a4");
    __asm volatile ("mov.aa " "a5" ", %0": : "a"(p_to->hdb.p_scb): "memory", "a5");
