#line 1 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_oo_scheduler.c"
/* ###*B*###
...
#line 55 "E:/Projects/Erika/aurix_workspace/examples_erika/multicore_semaphore/ee/erika/src/ee_oo_scheduler.c"
...
)
{
  ...
  MemSize const  queue_index = (MemSize)tmp_index; /* MISRA 10.8 */
  OsEE_rq_queue  * const 
    p_rq_queue = &p_rq->queue[queue_index];

  p_sn_new->p_tdb = p_tdb_new;

  if (p_rq_queue->p_head == ((void *) 0)) {
