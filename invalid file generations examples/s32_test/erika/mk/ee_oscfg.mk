...
OS_EE_OPT += OSEE_CPU_CLOCK (48000000U)
...
############################################################################
#
# Linker script for GCC compiler of  MCU for CORTEX_M (S32K1XX)
#
############################################################################
OS_EE_LINKER_SCRIPT := $(OS_EE_APP_BASE_DIR)/custom_ram.ld
export OS_EE_LINKER_SCRIPT
