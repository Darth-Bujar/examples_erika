# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
# 34 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.h" 1
# 37 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.h"
...
# 38 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.h" 2
...
# 35 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 2
# 53 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
static 
# 53 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
      _Bool 
# 53 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
           ENET_Timeout(uint32_t startTime, uint32_t timeout)
{
    uint32_t currentTime;
    
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
   _Bool 
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
        retVal;
...
# 61 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                                        1 
# 61 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                             : 
# 61 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                                               0
# 61 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
...
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                                                            1 
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                                                 : 
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                                                                   0
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
...
# 81 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_ConfigBufferDescriptors(ENET_Type * base,
                                  uint8_t ring,
                                  const enet_buffer_config_t *bufferConfig,
                                  uint16_t buffSize)
...
# 111 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
}
# 121 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_ConfigReceiveControl(ENET_Type *base,
                               const enet_config_t *config)
{
    uint32_t rcr = 0;
    ...
    rcr = (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_ENABLE_PAYLOAD_LEN_CHECK) != 0UL) ? 1UL : 0UL))<<30u))&0x40000000u) |
          ...
          (((uint32_t)(((uint32_t)((config->miiMode == ENET_RMII_MODE) ? 1UL : 0UL))<<8u))&0x100u) |
          (((uint32_t)(((uint32_t)((config->miiSpeed == ENET_MII_SPEED_10M) ? 1UL : 0UL))<<9u))&0x200u) |
...
# 174 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_ConfigTransmitControl(ENET_Type *base,
                                const enet_config_t *config)
{
...
# 201 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_WriteManagementConfig(ENET_Type * base,
                                uint32_t miiSpeed,
                                uint32_t holdTime,
                                
# 204 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                               _Bool 
# 204 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                    miiPreambleDisabled)
{
 uint32_t config;
...
# 223 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                  _Bool 
# 223 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                       clause45,
                                   uint32_t startTime,
                                   uint32_t timeoutMs)
{
    ...
    base->MMFR = (clause45 ? (((uint32_t)(((uint32_t)((0U)))<<30u))&0xC0000000u) : (((uint32_t)(((uint32_t)((1U)))<<30u))&0xC0000000u)) |
...
# 259 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                        _Bool 
# 259 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                             enable)
 {
...
# 305 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
}
# 315 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_TransmitIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
...
# 323 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                              ((void *)0)
# 323 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                  )
        {
...
# 365 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
    }
}
# 377 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_ReceiveIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
    ...
    if ((((uint32_t)ENET_RX_BUFFER_INTERRUPT | (uint32_t)ENET_RX_FRAME_INTERRUPT) & base->EIR) != 0U)
    {
        ...
        if (g_enetState[instance]->callback != 
# 385 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                              ((void *)0)
# 385 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                  )
        {
...
# 514 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_ErrorIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
    ...
    if ((errMask & base->EIR) != 0U)
    {
        ...
        if (g_enetState[instance]->callback != 
# 525 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                              ((void *)0)
# 525 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                  )
        {
...
# 545 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_WakeIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
    ...
    {
        ENET_DRV_SetSleepMode(instance, 
# 551 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                       0
# 551 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                            );

        if (g_enetState[instance]->callback != 
# 553 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                              ((void *)0)
# 553 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                  )
        {
...
# 574 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
void ENET_TimerIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
    ...
    {
        if (g_enetState[instance]->timerCallback != 
# 580 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c" 3 4
                                                   ((void *)0)
# 580 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\enet\\enet_hw_access.c"
                                                       )
        {
