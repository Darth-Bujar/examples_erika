# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
# 40 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
...
# 41 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 2
...
# 42 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 2
...
static status_t POWER_SYS_CallbacksManagement(power_manager_notify_struct_t * notifyStruct,
                                              ...
                                              power_manager_policy_t policy);
# 70 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
status_t POWER_SYS_Init(power_manager_user_config_t * (*powerConfigsPtr)[],
                        uint8_t configsNumber,
                        power_manager_callback_user_config_t * (*callbacksPtr)[],
                        uint8_t callbacksNumber)
{
    ...
    if (callbacksPtr != 
# 86 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                       ((void *)0)
# 86 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                           )
    {
    ...
    {
        gPowerManagerState.staticCallbacks = 
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                                            ((void *)0)
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                                                ;
...
# 110 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
status_t POWER_SYS_Deinit(void)
{
    gPowerManagerState.configs = 
# 112 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                                ((void *)0)
# 112 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                                    ;
    gPowerManagerState.configsNumber = 0U;
    gPowerManagerState.staticCallbacks = 
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                                        ((void *)0)
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                                            ;
    gPowerManagerState.staticCallbacksNumber = 0U;

    return POWER_SYS_DoDeinit();
}
# 133 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
status_t POWER_SYS_GetLastMode(uint8_t * powerModeIndexPtr)
{
    status_t returnCode;
...
# 165 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
status_t POWER_SYS_GetLastModeConfig(power_manager_user_config_t ** powerModePtr)
{
    status_t returnCode;
...
# 196 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
uint8_t POWER_SYS_GetErrorCallbackIndex(void)
{
    return gPowerManagerState.errorCallbackIndex;
}
# 208 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
power_manager_callback_user_config_t * POWER_SYS_GetErrorCallback(void)
{
...
# 213 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                                                       ((void *)0) 
# 213 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                                                            : (*gPowerManagerState.staticCallbacks)[gPowerManagerState.errorCallbackIndex];
}
# 224 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
static status_t POWER_SYS_CallbacksManagement(power_manager_notify_struct_t * notifyStruct,
                                              uint8_t * currentStaticCallback,
                                              power_manager_policy_t policy)
{
    ...
    for ((*currentStaticCallback) = 0U; (*currentStaticCallback) < callbacksNumber; (*currentStaticCallback)++)
    {
        ...
        if ((callbackConfig != 
# 269 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                              ((void *)0)
# 269 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                                  ) && (callbackTypeFilter != callbackConfig->callbackType))
        {
...
# 323 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
status_t POWER_SYS_SetMode(uint8_t powerModeIndex,
                           power_manager_policy_t policy)
{
...
# 329 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
   _Bool 
# 329 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
        successfulSwitch;
    uint8_t currentStaticCallback = 0U;
    ...
    else
    {
        ...
        successfulSwitch = 
# 370 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c" 3 4
                          0
# 370 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
                               ;
    }
...
# 406 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\power\\power_manager.c"
void POWER_SYS_GetDefaultConfig(power_manager_user_config_t * const config)
{
