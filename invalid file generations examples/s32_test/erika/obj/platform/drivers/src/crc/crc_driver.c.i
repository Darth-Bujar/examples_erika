# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
# 41 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
...
# 42 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c" 2

# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h" 1
# 21 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 1
# 21 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
...
# 22 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 2
...
# 24 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 2
# 44 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
typedef enum
{
...
# 83 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
typedef struct
{
...
# 95 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 3 4
   _Bool 
# 95 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
        complementChecksum;
    uint32_t seed;
} crc_user_config_t;
# 121 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
status_t CRC_DRV_Init(uint32_t instance,
                      const crc_user_config_t * userConfigPtr);
# 132 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
status_t CRC_DRV_Deinit(uint32_t instance);
# 149 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
uint32_t CRC_DRV_GetCrc32(uint32_t instance,
                          uint32_t data,
                          
# 151 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 3 4
                         _Bool 
# 151 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
                              newSeed,
                          uint32_t seed);
# 169 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
uint32_t CRC_DRV_GetCrc16(uint32_t instance,
                          uint16_t data,
                          
# 171 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 3 4
                         _Bool 
# 171 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
                              newSeed,
                          uint32_t seed);
# 189 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
uint32_t CRC_DRV_GetCrc8(uint32_t instance,
                         uint8_t data,
                         
# 191 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h" 3 4
                        _Bool 
# 191 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
                             newSeed,
                         uint32_t seed);
# 203 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
void CRC_DRV_WriteData(uint32_t instance,
                       const uint8_t * data,
                       uint32_t dataSize);
# 215 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
uint32_t CRC_DRV_GetCrcResult(uint32_t instance);
# 226 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
status_t CRC_DRV_Configure(uint32_t instance,
                           const crc_user_config_t * userConfigPtr);
# 238 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
status_t CRC_DRV_GetConfig(uint32_t instance,
                           crc_user_config_t * const userConfigPtr);
# 249 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/crc_driver.h"
status_t CRC_DRV_GetDefaultConfig(crc_user_config_t * const userConfigPtr);
# 22 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h" 2
# 60 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
void CRC_Init(CRC_Type * const base);
# 70 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
uint32_t CRC_GetCrcResult(const CRC_Type * const base);
# 80 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
void CRC_SetSeedReg(CRC_Type * const base,
              uint32_t seedValue);
# 91 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline uint32_t CRC_GetDataReg(const CRC_Type * const base)
{
    return base->DATAu.DATA;
}
# 104 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetDataReg(CRC_Type * const base,
                                  uint32_t value)
{
    base->DATAu.DATA = value;
}
# 118 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline uint16_t CRC_GetDataHReg(const CRC_Type * const base)
{
    return base->DATAu.DATA_16.H;
}
# 131 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline uint16_t CRC_GetDataLReg(const CRC_Type * const base)
{
    return base->DATAu.DATA_16.L;
}
# 144 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetDataLReg(CRC_Type * const base,
                                   uint16_t value)
{
    base->DATAu.DATA_16.L = value;
}
# 158 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetDataLLReg(CRC_Type * const base,
                                    uint8_t value)
{
    base->DATAu.DATA_8.LL = value;
}
# 172 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline uint32_t CRC_GetPolyReg(const CRC_Type * const base)
{
    return base->GPOLY;
}
# 185 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetPolyReg(CRC_Type * const base,
                                  uint32_t value)
{
    base->GPOLY = value;
}
# 201 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetSeedOrDataMode(CRC_Type * const base,
                                         
# 202 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h" 3 4
                                        _Bool 
# 202 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
                                             enable)
{
    uint32_t ctrlTemp = base->CTRL;

    ctrlTemp &= ~(0x2000000u);
    ctrlTemp |= (((uint32_t)(((uint32_t)(enable ? 1UL : 0UL))<<25u))&0x2000000u);
    base->CTRL = ctrlTemp;
}
# 223 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline 
# 223 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h" 3 4
             _Bool 
# 223 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
                  CRC_GetFXorMode(const CRC_Type * const base)
{
    return ((base->CTRL & 0x4000000u) >> 26u) != 0U;
}
# 238 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetFXorMode(CRC_Type * const base,
                                   
# 239 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h" 3 4
                                  _Bool 
# 239 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
                                       enable)
{
    uint32_t ctrlTemp = base->CTRL;

    ctrlTemp &= ~(0x4000000u);
    ctrlTemp |= (((uint32_t)(((uint32_t)(enable ? 1UL : 0UL))<<26u))&0x4000000u);
    base->CTRL = ctrlTemp;
}
# 258 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline crc_bit_width_t CRC_GetProtocolWidth(const CRC_Type * const base)
{
    crc_bit_width_t retVal = CRC_BITS_16;

    if (((base->CTRL & 0x1000000u) >> 24u) != 0U)
    {
        retVal = CRC_BITS_32;
    }
...
# 280 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
                                        ...
                                        crc_bit_width_t width)
{
    ...
    ctrlTemp &= ~(0x1000000u);
    ctrlTemp |= (((uint32_t)(((uint32_t)(width))<<24u))&0x1000000u);
    base->CTRL = ctrlTemp;
}
# 298 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline crc_transpose_t CRC_GetWriteTranspose(const CRC_Type * const base)
{
    crc_transpose_t type;
    uint32_t temp = (base->CTRL & 0xC0000000u) >> 30u;
...
# 330 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetWriteTranspose(CRC_Type * const base,
                                         crc_transpose_t transp)
{
    uint32_t ctrlTemp = base->CTRL;

    ctrlTemp &= ~(0xC0000000u);
    ctrlTemp |= (((uint32_t)(((uint32_t)(transp))<<30u))&0xC0000000u);
    base->CTRL = ctrlTemp;
}
# 348 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline crc_transpose_t CRC_GetReadTranspose(const CRC_Type * const base)
{
    crc_transpose_t type;
    uint32_t temp = (base->CTRL & 0x30000000u) >> 28u;
...
# 380 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_hw_access.h"
static inline void CRC_SetReadTranspose(CRC_Type * const base,
                                        crc_transpose_t transp)
{
    uint32_t ctrlTemp = base->CTRL;

    ctrlTemp &= ~(0x30000000u);
    ctrlTemp |= (((uint32_t)(((uint32_t)(transp))<<28u))&0x30000000u);
    base->CTRL = ctrlTemp;
}
# 44 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c" 2
# 52 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
static CRC_Type * const s_crcBase[] = { ((CRC_Type *)(0x40032000u)) };
# 65 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
status_t CRC_DRV_Init(uint32_t instance,
                      const crc_user_config_t * userConfigPtr)
{
    ((void)0);
...
# 88 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
status_t CRC_DRV_Deinit(uint32_t instance)
{
    ((void)0);
    CRC_Type * base = s_crcBase[instance];
...
# 108 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
uint32_t CRC_DRV_GetCrc32(uint32_t instance,
                          uint32_t data,
                          
# 110 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c" 3 4
                         _Bool 
# 110 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
                              newSeed,
                          uint32_t seed)
{
    ((void)0);
...
# 139 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
uint32_t CRC_DRV_GetCrc16(uint32_t instance,
                          uint16_t data,
                          
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c" 3 4
                         _Bool 
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
                              newSeed,
                          uint32_t seed)
{
    ((void)0);
...
# 169 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
uint32_t CRC_DRV_GetCrc8(uint32_t instance,
                         uint8_t data,
                         
# 171 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c" 3 4
                        _Bool 
# 171 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
                             newSeed,
                         uint32_t seed)
{
    ((void)0);
...
# 197 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
void CRC_DRV_WriteData(uint32_t instance,
                       const uint8_t * data,
                       uint32_t dataSize)
{
...
# 220 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
uint32_t CRC_DRV_GetCrcResult(uint32_t instance)
{
    ((void)0);
...
# 236 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
status_t CRC_DRV_Configure(uint32_t instance,
                           const crc_user_config_t * userConfigPtr)
{
    ((void)0);
...
# 268 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
status_t CRC_DRV_GetConfig(uint32_t instance,
                           crc_user_config_t * const userConfigPtr)
{
    ((void)0);
...
# 300 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
status_t CRC_DRV_GetDefaultConfig(crc_user_config_t * const userConfigPtr)
{
    ((void)0);
    ...
    userConfigPtr->crcWidth = CRC_BITS_16;


    userConfigPtr->polynomial = (0x1021U);

    userConfigPtr->readTranspose = CRC_TRANSPOSE_NONE;

    userConfigPtr->writeTranspose = CRC_TRANSPOSE_NONE;

    userConfigPtr->complementChecksum = 
# 315 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c" 3 4
                                         0
# 315 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\crc\\crc_driver.c"
                                              ;
