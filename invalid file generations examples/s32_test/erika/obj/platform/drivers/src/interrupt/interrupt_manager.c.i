# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
# 60 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
...
# 61 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c" 2
# 1 "C:\\NXP\\S32_SD~1.3/platform/devices/startup.h" 1
# 20 "C:\\NXP\\S32_SD~1.3/platform/devices/startup.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/devices/device_registers.h" 1
# 21 "C:\\NXP\\S32_SD~1.3/platform/devices/startup.h" 2
# 93 "C:\\NXP\\S32_SD~1.3/platform/devices/startup.h"
...
# 124 "C:\\NXP\\S32_SD~1.3/platform/devices/startup.h"
void init_data_bss(void);
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c" 2
# 70 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
static int32_t g_interruptDisableCount = 0;
# 86 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
    extern uint32_t __VECTOR_RAM[((uint32_t)((FTM7_Ovf_Reload_IRQn))) + 16U + 1U];
    extern uint32_t __VECTOR_TABLE[((uint32_t)((FTM7_Ovf_Reload_IRQn))) + 16U + 1U];
    extern uint32_t __DATA_ROM[];
    extern uint32_t __DATA_END[];
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_InstallHandler(IRQn_Type irqNumber,
                            const isr_t newHandler,
                            isr_t* const oldHandler)
{
# 128 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
...
# 167 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
...
# 190 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_EnableIRQ(IRQn_Type irqNumber)
{
...
# 208 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
}
# 219 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_DisableIRQ(IRQn_Type irqNumber)
{
...
# 238 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
}
# 248 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_EnableIRQGlobal(void)
{
...
# 271 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_DisableIRQGlobal(void)
{
...
# 289 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_SetPriority(IRQn_Type irqNumber, uint8_t priority)
{
# 302 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
...
# 322 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
    ...
    {
# 340 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
        ((S32_NVIC_Type *)(0xE000E100u))->IP[(uint32_t)(irqNumber)] = (uint8_t)(((((uint32_t)priority) << shift)) & 0xFFUL);

    }
}
# 354 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
uint8_t INT_SYS_GetPriority(IRQn_Type irqNumber)
{
# 366 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
    uint8_t priority = 0U;
    uint8_t shift = (uint8_t) (8U - (4U));
    ...
    if ((int32_t)irqNumber < 0)
    {
        uint32_t intVectorId = ((uint32_t)(irqNumber) & 0xFU);
        uint32_t regId = intVectorId / 4U;
# 383 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
...
# 414 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_ClearPending(IRQn_Type irqNumber)
{
# 442 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
    ((S32_NVIC_Type *)(0xE000E100u))->ICPR[(uint32_t)(irqNumber) >> 5U] = (uint32_t)(1UL << ((uint32_t)(irqNumber) & (uint32_t)0x1FU));
}
# 453 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
void INT_SYS_SetPending(IRQn_Type irqNumber)
{
...
# 474 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
uint32_t INT_SYS_GetPending(IRQn_Type irqNumber)
{
# 494 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
    return ((uint32_t)(((((S32_NVIC_Type *)(0xE000E100u))->ISPR[(((uint32_t)irqNumber) >> 5UL)] & (1UL << (((uint32_t)irqNumber) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
}
# 507 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\interrupt\\interrupt_manager.c"
uint32_t INT_SYS_GetActive(IRQn_Type irqNumber)
{
