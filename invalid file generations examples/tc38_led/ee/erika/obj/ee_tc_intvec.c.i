...
void __interrupt_fast(2) __vector_table(1)     osEE_tc_core1_isr_dummy_entry_2(void)             {                                                     for(;;);                                          }
...
void __interrupt_fast(2) __vector_table(2)     osEE_tc_core2_isr_dummy_entry_2(void)             {                                                     for(;;);                                          }
