# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
# 26 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
...
# 27 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c" 2
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_gpio_hw_access.h" 1
# 19 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_gpio_hw_access.h"
...
# 20 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_gpio_hw_access.h" 2
...
# 28 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c" 2
...
void PINS_SetGlobalIntControl(PORT_Type * const base,
                              ...
                              uint16_t value,
                              port_global_control_pins_t halfPort);
# 32 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c" 2
# 50 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
status_t PINS_DRV_Init(uint32_t pinCount,
                       const pin_settings_config_t config[])
{
    uint32_t i;
...
# 71 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetPullSel(PORT_Type * const base,
                         uint32_t pin,
                         port_pull_config_t pullConfig)
{
...
# 87 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetMuxModeSel(PORT_Type * const base,
                            uint32_t pin,
                            port_mux_t mux)
{
...
# 101 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetPinIntSel(PORT_Type * const base,
                           uint32_t pin,
                           port_interrupt_config_t intConfig)
{
...
# 115 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
port_interrupt_config_t PINS_DRV_GetPinIntSel(const PORT_Type * const base,
                                              uint32_t pin)
{
    return PINS_GetPinIntSel(base, pin);
}
# 128 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_ClearPinIntFlagCmd(PORT_Type * const base,
                                 uint32_t pin)
{
    PINS_ClearPinIntFlagCmd(base, pin);
}
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_EnableDigitalFilter(PORT_Type * const base,
                                  uint32_t pin)
{
    PINS_EnableDigitalFilter(base, pin);
}
# 155 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_DisableDigitalFilter(PORT_Type * const base,
                                   uint32_t pin)
{
    PINS_DisableDigitalFilter(base, pin);
}
# 169 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_ConfigDigitalFilter(PORT_Type * const base,
                                  const port_digital_filter_config_t * const config)
{
    PINS_ConfigDigitalFilter(base, config);
}
# 182 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
uint32_t PINS_DRV_GetPortIntFlag(const PORT_Type * const base)
{
    return PINS_GetPortIntFlag(base);
}
# 194 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_ClearPortIntFlagCmd(PORT_Type * const base)
{
    PINS_ClearPortIntFlagCmd(base);
}
# 208 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
pins_channel_type_t PINS_DRV_GetPinsDirection(const GPIO_Type * const base)
{
    return PINS_GPIO_GetPinsDirection(base);
}
# 222 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetPinDirection(GPIO_Type * const base,
                              pins_channel_type_t pin,
                              pins_level_type_t direction)
{
...
# 239 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetPinsDirection(GPIO_Type * const base,
                               pins_channel_type_t pins)
{
    PINS_GPIO_SetPinsDirection(base, pins);
}
# 256 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetPortInputDisable(GPIO_Type * const base,
                                  pins_channel_type_t pins)
{
    PINS_GPIO_SetPortInputDisable(base, pins);
}
# 271 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
pins_channel_type_t PINS_DRV_GetPortInputDisable(const GPIO_Type * const base)
{
    return PINS_GPIO_GetPortInputDisable(base);
}
# 286 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetGlobalPinControl(PORT_Type * const base,
                                  uint16_t pins,
                                  uint16_t value,
                                  port_global_control_pins_t halfPort)
...
# 303 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetGlobalIntControl(PORT_Type * const base,
                                  uint16_t pins,
                                  uint16_t value,
                                  port_global_control_pins_t halfPort)
...
# 468 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_WritePin(GPIO_Type * const base,
                       pins_channel_type_t pin,
                       pins_level_type_t value)
{
...
# 483 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_WritePins(GPIO_Type * const base,
                        pins_channel_type_t pins)
{
    PINS_GPIO_WritePins(base, pins);
}
# 497 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
pins_channel_type_t PINS_DRV_GetPinsOutput(const GPIO_Type * const base)
{
    return PINS_GPIO_GetPinsOutput(base);
}
# 511 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_SetPins(GPIO_Type * const base,
                      pins_channel_type_t pins)
{
    PINS_GPIO_SetPins(base, pins);
}
# 526 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_ClearPins(GPIO_Type * const base,
                        pins_channel_type_t pins)
{
    PINS_GPIO_ClearPins(base, pins);
}
# 540 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
void PINS_DRV_TogglePins(GPIO_Type * const base,
                         pins_channel_type_t pins)
{
    PINS_GPIO_TogglePins(base, pins);
}
# 554 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\pins\\pins_driver.c"
pins_channel_type_t PINS_DRV_ReadPins(const GPIO_Type * const base)
{
