# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
# 30 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
...
# 31 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 2
# 43 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
status_t RTC_Enable(RTC_Type * const base)
{
    status_t statusCode = STATUS_SUCCESS;
    
# 46 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
   _Bool 
# 46 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
        isCounterEnabled;
    ...
    else
    {
        ...
        RTC_SetTimeCounterEnable(base, 
# 59 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                                      1
# 59 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
                                          );
    }

    return statusCode;
}
# 72 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
status_t RTC_Disable(RTC_Type * const base)
{

 if (RTC_GetTimeCounterEnable(base) == 
# 75 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                                      1
# 75 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
                                          )
    {
        RTC_SetTimeCounterEnable(base, 
# 77 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                                      0
# 77 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
                                           );
    }
...
# 97 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
status_t RTC_SetTimeSecondsRegister(RTC_Type * const base, uint32_t seconds)
{
    status_t statusCode = STATUS_SUCCESS;

    if (RTC_GetTimeCounterEnable(base) == 
# 101 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                                         1
# 101 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
                                             )
    {
        statusCode = STATUS_ERROR;
    }
...
# 124 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
status_t RTC_ConfigureRegisterLock(RTC_Type * const base, rtc_lock_register_select_t registerToConfig)
{
    status_t statusCode = STATUS_SUCCESS;
    ...
    if (RTC_GetLockRegisterLock(base) == 
# 132 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                                        1
# 132 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
                                            )
    {
        statusCode = STATUS_ERROR;
    }
...
# 171 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
_Bool 
# 171 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
    RTC_IsRegisterLocked(const RTC_Type * const base, rtc_lock_register_select_t reg)
{
    
# 173 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
   _Bool 
# 173 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
        state = 
# 173 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                0
# 173 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
...
# 205 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
status_t RTC_ConfigureClockOut(RTC_Type * const base, rtc_clk_out_config_t config)
{
    status_t statusCode = STATUS_SUCCESS;
    ...
    if (RTC_GetControlRegisterLock(base) == 
# 213 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c" 3 4
                                           1
# 213 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\rtc\\rtc_hw_access.c"
                                               )
    {
        statusCode = STATUS_ERROR;
    }
    else
    {
        switch (config)
        {
            ...
            case RTC_CLKOUT_SRC_TSIC:
                ...
                base->CR &= ~(0x1000000u | 0x20u);
                base->CR |= ((((uint32_t)(((uint32_t)(1U))<<24u))&0x1000000u) | (((uint32_t)(((uint32_t)(0U))<<5u))&0x20u));
                break;
            case RTC_CLKOUT_SRC_32KHZ:

                base->CR &= ~(0x1000000u | 0x20u);
                base->CR |= ((((uint32_t)(((uint32_t)(1U))<<24u))&0x1000000u) | (((uint32_t)(((uint32_t)(1U))<<5u))&0x20u));
                break;
            default:
