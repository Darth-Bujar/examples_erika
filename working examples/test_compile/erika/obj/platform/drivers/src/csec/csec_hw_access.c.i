# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
# 16 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h" 1
# 19 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h"
...
# 20 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h" 2
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stdbool.h" 1 3 4
# 21 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h" 2
...
# 22 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h" 2
...
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h" 2
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/csec_driver.h" 1
# 21 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/csec_driver.h"
...
# 57 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.h" 2
...
# 17 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c" 2
# 48 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
void CSEC_WriteCommandBytes(uint8_t offset, const uint8_t *bytes, uint8_t numBytes)
{
    uint8_t i = 0U;
    ...
    while ((i + 3U) < numBytes)
    {
        ((CSE_PRAM_Type *)(0x14001000u))->RAMn[(offset + i) >> 2U].DATA_32 =
            (((uint32_t)(((uint32_t)(bytes[i]))<<24u))&0xFF000000u) |
            (((uint32_t)(((uint32_t)(bytes[i + 1U]))<<16u))&0xFF0000u) |
            (((uint32_t)(((uint32_t)(bytes[i + 2U]))<<8u))&0xFF00u) |
            (((uint32_t)(((uint32_t)(bytes[i + 3U]))<<0u))&0xFFu);
        i = (uint8_t)(i + 4U);
    }
    while (i < numBytes)
    {
...
# 77 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
void CSEC_WriteCommandHalfWord(uint8_t offset, uint16_t halfWord)
{
    uint32_t tmp;

    tmp = ((CSE_PRAM_Type *)(0x14001000u))->RAMn[(offset >> 2U)].DATA_32;

    if ((offset & 2U) != 0U)
    {
        tmp = tmp & ~(0xFFFFU);
        tmp = tmp | ((((uint32_t) halfWord) << (0U)) & (0xFFFFU));
    }
    else
    {
        tmp = tmp & ~(0xFFFF0000U);
        tmp = tmp | ((((uint32_t) halfWord) << (0x10U)) & (0xFFFF0000U));
    }

    ((CSE_PRAM_Type *)(0x14001000u))->RAMn[(offset >> 2U)].DATA_32 = tmp;
}
...
void CSEC_WriteCommandByte(uint8_t offset, uint8_t byte)
{
    ...
    temp = ((CSE_PRAM_Type *)(0x14001000u))->RAMn[offset >> 2U].DATA_32;

    switch (offset & 0x3U)
    {
    case 0x0U:
     temp = temp & ~0xFF000000u;
     temp = temp | ((((uint32_t)(byte) << 24u)) & 0xFF000000u);
     break;
    case 0x1U:
     temp = temp & ~0xFF0000u;
  temp = temp | ((((uint32_t)(byte) << 16u)) & 0xFF0000u);
        break;
    case 0x2U:
     temp = temp & ~0xFF00u;
  temp = temp | ((((uint32_t)(byte) << 8u)) & 0xFF00u);
        break;
    case 0x3U:
     temp = temp & ~0xFFu;
  temp = temp | ((((uint32_t)(byte) << 0u)) & 0xFFu);
        break;
    default:

        break;
    }
    ((CSE_PRAM_Type *)(0x14001000u))->RAMn[offset >> 2U].DATA_32 = temp;
}
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
void CSEC_WriteCommandWords(uint8_t offset, const uint32_t *words, uint8_t numWords)
{
    uint8_t i = 0U;
    ...
    while (i < numWords)
    {
        ((CSE_PRAM_Type *)(0x14001000u))->RAMn[alignedOffset + i].DATA_32 = words[i];
        i++;
    }
}
# 162 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
void CSEC_ReadCommandBytes(uint8_t offset, uint8_t *bytes, uint8_t numBytes)
{
    uint8_t i = 0U;
    ...
    while ((i + 3U) < numBytes)
    {
        uint32_t tmp = ((CSE_PRAM_Type *)(0x14001000u))->RAMn[(offset + i) >> 2U].DATA_32;

        bytes[i] = (uint8_t)((tmp & 0xFF000000u) >> 24u);
        bytes[i + 1U] = (uint8_t)((tmp & 0xFF0000u) >> 16u);
        bytes[i + 2U] = (uint8_t)((tmp & 0xFF00u) >> 8u);
        bytes[i + 3U] = (uint8_t)((tmp & 0xFFu) >> 0u);
        i = (uint8_t)(i + 4U);
    }
    while (i < numBytes)
    {
...
uint8_t CSEC_ReadCommandByte(uint8_t offset)
{
    ...
    {
    case 0x0U:
        byte = (uint8_t)((temp & 0xFF000000u) >> 24u);
        break;
    case 0x1U:
        byte = (uint8_t)((temp & 0xFF0000u) >> 16u);
        break;
    case 0x2U:
        byte = (uint8_t)((temp & 0xFF00u) >> 8u);
        break;
    case 0x3U:
        byte = (uint8_t)((temp & 0xFFu) >> 0u);
        break;
    default:
...
# 227 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\csec\\csec_hw_access.c"
