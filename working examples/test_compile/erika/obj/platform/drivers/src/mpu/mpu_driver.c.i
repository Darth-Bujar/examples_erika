# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
# 37 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
...
# 38 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 2
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h" 1
# 23 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h" 1
# 23 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
...
# 24 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h" 2
...
# 25 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h" 2
# 41 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
typedef enum
{
...
# 121 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
typedef enum
{
# 131 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
...
# 178 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h" 3 4
   _Bool 
# 178 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
                               processIdentifierEnable;
...
# 226 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
...
# 246 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
void MPU_DRV_SetRegionAddr(uint32_t instance,
                           uint8_t regionNum,
                           uint32_t startAddr,
                           uint32_t endAddr);
# 263 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
status_t MPU_DRV_SetRegionConfig(uint32_t instance,
                                 uint8_t regionNum,
                                 const mpu_user_config_t * userConfigPtr);
# 277 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
status_t MPU_DRV_SetMasterAccessRights(uint32_t instance,
                                       uint8_t regionNum,
                                       const mpu_master_access_right_t * accessRightsPtr);
# 292 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"

# 292 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h" 3 4
_Bool 
# 292 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
    MPU_DRV_GetDetailErrorAccessInfo(uint32_t instance,
                                      uint8_t slavePortNum,
                                      mpu_access_err_info_t * errInfoPtr);
# 304 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
mpu_user_config_t MPU_DRV_GetDefaultRegionConfig(mpu_master_access_right_t * masterAccRight);
# 316 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
void MPU_DRV_EnableRegion(uint32_t instance,
                          uint8_t regionNum,
                          
# 318 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h" 3 4
                         _Bool 
# 318 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/mpu_driver.h"
                              enable);
# 24 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h" 2
# 45 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
static inline void MPU_Enable(MPU_Type * const base,
                              
# 46 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h" 3 4
                             _Bool 
# 46 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
                                  enable)
{
    base->CESR = (base->CESR & ~0x1u) | (((uint32_t)(((uint32_t)(enable ? 1UL : 0UL))<<0u))&0x1u);
}
# 60 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
static inline void MPU_SetRegionValidCmd(MPU_Type * const base,
                                         uint8_t regionNum,
                                         
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h" 3 4
                                        _Bool 
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
                                             enable)
{
    base->RGD[regionNum].WORD3 = ((base->RGD[regionNum].WORD3 & ~0x1u)
                               | (((uint32_t)(((uint32_t)(enable ? 1UL : 0UL))<<0u))&0x1u));
}
# 76 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
static inline void MPU_SetProcessIdentifier(MPU_Type * const base,
                                            uint8_t regionNum,
                                            uint8_t pid)
{
    base->RGD[regionNum].WORD3 = (base->RGD[regionNum].WORD3 & ~0xFF000000u)
                               | (((uint32_t)(((uint32_t)(pid))<<24u))&0xFF000000u);
}
# 91 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
static inline void MPU_SetProcessIdentifierMask(MPU_Type * const base,
                                                uint8_t regionNum,
                                                uint8_t pidMask)
{
    base->RGD[regionNum].WORD3 = (base->RGD[regionNum].WORD3 & ~0xFF0000u)
                               | (((uint32_t)(((uint32_t)(pidMask))<<16u))&0xFF0000u);
}
# 108 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
void MPU_SetRegionAddr(MPU_Type * const base,
                       uint8_t regionNum,
                       uint32_t startAddr,
                       uint32_t endAddr);
# 122 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
...
void MPU_InitRegion(MPU_Type * const base,
                    uint8_t regionNum);
# 144 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
static inline 
# 144 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h" 3 4
             _Bool 
# 144 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
                  MPU_GetErrorStatus(const MPU_Type * const base,
                                      uint8_t slaveNum)
{

    return ((base->CESR & (((uint32_t)(((uint32_t)(1UL << (((5u) - 1U) - slaveNum)))<<(27u)))&(0xF8000000U))) != 0U);
}
...
static inline void MPU_ClearErrorFlag(MPU_Type * const base,
                                      uint8_t slaveNum)
{
    base->CESR = (base->CESR & ~(0xF8000000U))
               | (((uint32_t)(((uint32_t)(1UL << (((5u) - 1U) - slaveNum)))<<(27u)))&(0xF8000000U));
}
# 171 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_hw_access.h"
...
# 39 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 2





static MPU_Type * const s_mpuBase[(1u)] = { ((MPU_Type *)(0x4000D000u)) };
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
status_t MPU_DRV_Init(uint32_t instance,
                      uint8_t regionCnt,
                      const mpu_user_config_t * userConfigArr)
{
    ...
    if (retStatus == STATUS_SUCCESS)
    {
        ...
        MPU_Enable(base, 
# 91 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
                        1
# 91 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
                            );
    }

    return retStatus;
}
# 105 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
void MPU_DRV_Deinit(uint32_t instance)
{
    ((void)0);
    ...
    MPU_Enable(base, 
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
                    0
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
                         );

    for (slaveNum = 0U; slaveNum < (5U); slaveNum++)
    {
    ...
    for (regionNum = 0U; regionNum < 16u; regionNum++)
    {

        MPU_InitRegion(base, regionNum);
    }
}
# 137 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
void MPU_DRV_SetRegionAddr(uint32_t instance,
                           uint8_t regionNum,
                           uint32_t startAddr,
                           uint32_t endAddr)
{
    ...
    MPU_SetRegionValidCmd(base, regionNum, 
# 152 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
                                          1
# 152 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
                                              );
}
# 164 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
status_t MPU_DRV_SetRegionConfig(uint32_t instance,
                                 uint8_t regionNum,
                                 const mpu_user_config_t * userConfigPtr)
{
    ...
    for (masterIdx = 0U; masterIdx < (4U); masterIdx++)
    {
        if (userConfigPtr->masterAccRight[masterIdx].masterNum <= (7U))
        {
    ...
    if (regionNum > 0U)
    {
        if (returnCode == STATUS_SUCCESS)
        {
            ...
            MPU_SetRegionValidCmd(base, regionNum, 
# 210 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
                                                  1
# 210 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
                                                      );
        }
    }
...
# 224 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
status_t MPU_DRV_SetMasterAccessRights(uint32_t instance,
                                       uint8_t regionNum,
                                       const mpu_master_access_right_t * accessRightsPtr)
{
    ...
    if (accessRightsPtr->masterNum <= (7U))
    {
...
# 256 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"

# 256 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
_Bool 
# 256 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
    MPU_DRV_GetDetailErrorAccessInfo(uint32_t instance,
                                      uint8_t slavePortNum,
...
# 265 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
   _Bool 
# 265 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
        errorStatus = 
# 265 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
                      0
# 265 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
...
# 308 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
mpu_user_config_t MPU_DRV_GetDefaultRegionConfig(mpu_master_access_right_t * masterAccRight)
{
    ((void)0);

    uint8_t masterIdx = 0U;
    uint8_t masterNum[(4U)] = { (0U), (1U), (2U), (3U), };
...
# 344 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
void MPU_DRV_EnableRegion(uint32_t instance,
                          uint8_t regionNum,
                          
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c" 3 4
                         _Bool 
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\mpu\\mpu_driver.c"
                              enable)
{
    ((void)0);
    ((void)0);
