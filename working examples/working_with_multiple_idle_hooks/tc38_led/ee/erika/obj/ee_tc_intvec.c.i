  ...
  osEE_hal_begin_nested_primitive(void)
{
  ...
  if (icr.bits.ccpn < OSEE_ISR2_VIRT_TO_HW_PRIO((133U))) {
    OsEE_icr icr_temp = icr;
    /* Set new CCPN value */
    icr_temp.bits.ccpn = OSEE_ISR2_VIRT_TO_HW_PRIO((133U));
...
(*(OsEE_reg volatile *)0xF0037010U) = ((1U << 0) | (1U << 1));
...
void __interrupt_fast(6) __vector_table(1)         osEE_tc_core1_isr2_entry_6(void)                      {                                                         osEE_tc_isr2_wrapper(3);                             }
