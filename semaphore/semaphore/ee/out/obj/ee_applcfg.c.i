...
#line 31 "ee_applcfg.c"

SemType S = {
  /* .blocked_queue = */ ((void *) 0),
  /* .count = */         0U
};
...
static OsEE_stack __attribute__((__align((8U))))
  osEE_task_stack_3[((((512U)) + (8U) - 1U) / sizeof(OsEE_stack))];
...
static OsEE_SCB  osEE_scb_array[(4U)] =
{
  ...
  { /* .p_tos = */  (OsEE_CTX *)((OsEE_addr)&(osEE_task_stack_3)[((sizeof(osEE_task_stack_3)/sizeof((osEE_task_stack_3)[0])) - 1U) &     (~(((8U)/sizeof(OsEE_stack)) - 1U))]) },
  { /* .p_tos = */  ((void *) 0) }
};
...
static OsEE_SDB  osEE_sdb_array[(4U)] =
{
  ...
  {
    /* .p_bos = */      (OsEE_CTX *)((OsEE_addr)&(osEE_task_stack_3)[0U]),
    /* .stack_size = */ (512U)
  },
  {
  ...
  osEE_tdb_array[5]  =
{
  ...
  },
  {
    ...
    /* .task_func      = */ FuncHIGH_priority_task,
    /* .ready_prio     = */ 3U,
    /* .dispatch_prio  = */ 3U,
    /* .max_num_of_act = */ 1U
  },
  {
    ...
    /* .tid            = */ 2U,
    /* .task_type      = */ OSEE_TASK_TYPE_EXTENDED,
    /* .task_func      = */ FuncLOW_priority_task,
    /* .ready_prio     = */ 1U,
    /* .dispatch_prio  = */ 127U,
    /* .max_num_of_act = */ 1U
  },
  {
    ...
    /* .tid            = */ 3U,
    /* .task_type      = */ OSEE_TASK_TYPE_EXTENDED,
    /* .task_func      = */ FuncMID_priority_task,
    /* .ready_prio     = */ 2U,
    /* .dispatch_prio  = */ 2U,
    /* .max_num_of_act = */ 1U
  },
...
#line 464 "ee_applcfg.c"
OsEE_CCB  osEE_ccb_var = {
  /* .p_curr      = */  &osEE_tdb_array[4U],
  /* .rq          = */  {{{((void *) 0),((void *) 0)},{((void *) 0),((void *) 0)},{((void *) 0),((void *) 0)}},0U},
