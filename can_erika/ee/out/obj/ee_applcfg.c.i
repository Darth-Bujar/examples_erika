 ...
 *
 **************************************************************************/
extern void  Funccan_init_task ( void );
extern void  Funccan_recieve_task ( void );
...
#line 29 "ee_applcfg.c"

static OsEE_isr1_src  osEE_isr1_src_array[1] = {
  {
    /* .isr1_src = */ (0x05B0U),
    /* .isr_prio = */ (10U)
  }
...
#line 42 "ee_applcfg.c"

OsEE_isr1_db  osEE_isr1_db_instance = {
  /* .p_isr1_src_array = */ (OsEE_isr1_src (*  )[])&osEE_isr1_src_array,
  /* .isr1_num         = */ (sizeof(osEE_isr1_src_array)/sizeof(0[(osEE_isr1_src_array)]))
};
...
#line 60 "ee_applcfg.c"

extern __far OsEE_CTX __attribute__((__align((8U)))) _lc_ub_ustack_tc0[];

static OsEE_stack __attribute__((__align((8U))))
...
#line 82 "ee_applcfg.c"

static OsEE_SCB  osEE_scb_array[(3U)] =
{
  { /* .p_tos = */  (OsEE_CTX *)((OsEE_addr)&(osEE_task_stack_1)[((sizeof(osEE_task_stack_1)/sizeof((osEE_task_stack_1)[0])) - 1U) &     (~(((8U)/sizeof(OsEE_stack)) - 1U))]) },
  { /* .p_tos = */  (OsEE_CTX *)((OsEE_addr)&(osEE_task_stack_2)[((sizeof(osEE_task_stack_2)/sizeof((osEE_task_stack_2)[0])) - 1U) &     (~(((8U)/sizeof(OsEE_stack)) - 1U))]) },
  { /* .p_tos = */  ((void *) 0) }
};
...
#line 100 "ee_applcfg.c"

static OsEE_SDB  osEE_sdb_array[(3U)] =
{
  {
    /* .p_bos = */      (OsEE_CTX *)((OsEE_addr)&(osEE_task_stack_1)[0U]),
    /* .stack_size = */ (1024U)
  },
  {
    /* .p_bos = */      (OsEE_CTX *)((OsEE_addr)&(osEE_task_stack_2)[0U]),
    /* .stack_size = */ (512U)
  },
  {
  ...
  osEE_tdb_array[4]  =
{
  ...
  },
  {
    ...
    /* .tid            = */ 2U,
    /* .task_type      = */ OSEE_TASK_TYPE_EXTENDED,
    /* .task_func      = */ Funccan_recieve_task,
    /* .ready_prio     = */ 2U,
    /* .dispatch_prio  = */ 2U,
    /* .max_num_of_act = */ 1U
  },
...
{
  {
    /* .tdb_ptr_array = */    (OsEE_TDB * const (*  )[])&osEE_tdb_ptr_autostart_OSDEFAULTAPPMODE,
    /* .tdb_array_size  = */  (sizeof(osEE_tdb_ptr_autostart_OSDEFAULTAPPMODE)/sizeof(0[(osEE_tdb_ptr_autostart_OSDEFAULTAPPMODE)]))
  }};
...
{
  {
    /* .p_trigger_ptr_array = */  (OsEE_autostart_trigger_info (*  )[])&osEE_trigger_autostart_info_OSDEFAULTAPPMODE,
    /* .trigger_array_size  = */  (sizeof(osEE_trigger_autostart_info_OSDEFAULTAPPMODE)/sizeof(0[(osEE_trigger_autostart_info_OSDEFAULTAPPMODE)]))
  }
};
...
#line 402 "ee_applcfg.c"
OsEE_CCB  osEE_ccb_var = {
  /* .p_curr      = */  &osEE_tdb_array[3U],
  /* .rq          = */  {{{((void *) 0),((void *) 0)},{((void *) 0),((void *) 0)}},0U},
...
#line 429 "ee_applcfg.c"
OsEE_CDB  osEE_cdb_var = {
  {
    /* .p_sdb_array = */ (OsEE_SDB (*  )[])&osEE_sdb_array,
    /* .p_scb_array = */ (OsEE_SCB (*  )[])&osEE_scb_array,
    /* .stack_num   = */ (3U)
  },
  /* .p_ccb                         = */ &osEE_ccb_var,
  ...
  /* .p_autostart_tdb_array         = */ (OsEE_autostart_tdb (*  )[])&osEE_autostart_tdb_array,
  /* .autostart_tdb_array_size      = */ (sizeof(osEE_autostart_tdb_array)/sizeof(0[(osEE_autostart_tdb_array)])),
  /* .p_autostart_trigger_array     = */ (OsEE_autostart_trigger (*  )[])&osEE_autostart_trigger_db,
  /* .autostart_trigger_array_size  = */ (sizeof(osEE_autostart_trigger_db)/sizeof(0[(osEE_autostart_trigger_db)]))
};
...
#line 451 "ee_applcfg.c"
OsEE_KDB  osEE_kdb_var = {
  /* .p_kcb               = */ &osEE_kcb_var,
  /* .p_tdb_ptr_array     = */ (OsEE_TDB * const (*  )[])&osEE_tdb_ptr_array,
  /* .tdb_array_size      = */ (sizeof(osEE_tdb_ptr_array)/sizeof(0[(osEE_tdb_ptr_array)])),
  /* .p_counter_ptr_array = */ (OsEE_CounterDB * const (*  )[])&osEE_counter_db_ptr_array,
  /* .counter_array_size  = */ (sizeof(osEE_counter_db_ptr_array)/sizeof(0[(osEE_counter_db_ptr_array)])),
  /* .p_alarm_ptr_array   = */ (OsEE_AlarmDB * const (*  )[])&osEE_alarm_db_ptr_array,
  /* .alarm_array_size    = */ (sizeof(osEE_alarm_db_ptr_array)/sizeof(0[(osEE_alarm_db_ptr_array)]))
};
