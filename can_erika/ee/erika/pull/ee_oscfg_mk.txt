...
OS_EE_OPT += OSEE_TC_HAS_ISR1_TO_CONF
...
#
############################################################################
$(eval $(call check_and_set_cygwin_compiler_path,CCTCBIN,C:\Infineon\AURIX-Studio-1.9.4\plugins\com.infineon.aurix.tools_1.9.4\build_system\tools\Compilers\Tasking_1.1r8/ctc/bin/))
