# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\out//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
# 53 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
...
# 54 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c" 2
...
# 57 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c" 2
...
# 11 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\arm-none-eabi\\include\\_ansi.h" 3
...
# 59 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c" 2
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\arm-none-eabi\\include\\string.h" 1 3
# 17 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\arm-none-eabi\\include\\string.h" 3
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stddef.h" 1 3 4
...
# 60 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c" 2


# 61 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
OsEE_bool volatile stk_wrong = (0!=0);
...
# 105 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
extern SemType V;
# 116 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
...
# 145 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
void TimerISR ( void ) {
  ++isr2_fired;
  if (isr2_fired >=1000U)
  {
    ...
    if (!isr2_armed) {
      ...
      DemoHAL_SerialWrite((uint8_t const * )"ISR\r\n", 5U);
      ActivateTask((2U));
    } else {
      isr2_armed = 0U;
    }
...
void idle_hook ( void ) {
  ...
  if ( main_sp == 0 ) {
    ...
    do { DemoHAL_LedOn(DEMO_HAL_LED_1); DisableAllInterrupts(); serial_print("Test Failed!!!, line:" "168" " \r\n"); while ( 1 ) { ; } } while ( 0 );
  }
  ...
  if (idle_cnt >= 100000U) {
    ...
    DemoHAL_SerialWrite((uint8_t const * )"Idle\r\n", 6U);
  }
...
{
  DemoHAL_Init();
# 209 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\code.c"
...
void FuncTask1 ( void )
{
  ...
  if ( task1_sp == 0 ) {
    ...
    do { DemoHAL_LedOn(DEMO_HAL_LED_1); DisableAllInterrupts(); serial_print("Test Failed!!!, line:" "231" " \r\n"); while ( 1 ) { ; } } while ( 0 );
  }
  ...
  curr_sp = osEE_get_SP();
  if ( task1_sp != curr_sp ) {
    do { DemoHAL_LedOn(DEMO_HAL_LED_1); DisableAllInterrupts(); serial_print("Test Failed!!!, line:" "245" " \r\n"); while ( 1 ) { ; } } while ( 0 );
  }
...
void FuncTask2 ( void )
{
  ...
  if ( task2_sp == 0 ) {
    ...
    do { DemoHAL_LedOn(DEMO_HAL_LED_1); DisableAllInterrupts(); serial_print("Test Failed!!!, line:" "262" " \r\n"); while ( 1 ) { ; } } while ( 0 );
  }
