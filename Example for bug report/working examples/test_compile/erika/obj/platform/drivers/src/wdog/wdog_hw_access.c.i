# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
# 26 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
...
# 27 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c" 2
# 38 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
void WDOG_Deinit(WDOG_Type * const base)
{
...
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c" 3 4
                _Bool 
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
                     enable)
{
    ...
    base->CS = (base->CS & ~0x40u) | (((uint32_t)(((uint32_t)(enable? 1UL : 0UL))<<6u))&0x40u);
...
# 94 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c" 3 4
   _Bool 
# 94 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
        tmp1 = WDOG_IsEnabled(base);
    
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c" 3 4
   _Bool 
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
        tmp2 = WDOG_IsUpdateEnabled(base);

    INT_SYS_DisableIRQGlobal();

    if ((tmp1 == 
# 99 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c" 3 4
                0
# 99 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
                     ) && (tmp2 == 
# 99 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c" 3 4
                                   1
# 99 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\wdog\\wdog_hw_access.c"
                                       ))
    {
        ...
        cs |= (((uint32_t)(((uint32_t)(wdogUserConfig->winEnable ? 1UL : 0UL))<<15u))&0x8000u);
        cs |= (((uint32_t)(((uint32_t)(wdogUserConfig->prescalerEnable ? 1UL : 0UL))<<12u))&0x1000u);
        cs |= (((uint32_t)(((uint32_t)(wdogUserConfig->clkSource))<<8u))&0x300u);
        cs |= (((uint32_t)(((uint32_t)(wdogUserConfig->intEnable ? 1UL : 0UL))<<6u))&0x40u);
        cs |= (((uint32_t)(((uint32_t)(wdogUserConfig->updateEnable ? 1UL : 0UL))<<5u))&0x20u);
...
wdog_user_config_t WDOG_GetConfig(const WDOG_Type *base)
{
    ...
    config.winEnable = ((cs & 0x8000u) != 0U);
    config.prescalerEnable = ((cs & 0x1000u) != 0U);
    config.intEnable = ((cs & 0x40u) != 0U);
    config.updateEnable = ((cs & 0x20u) != 0U);
    config.opMode.debug = ((cs & 0x4u) != 0U);
    config.opMode.wait = ((cs & 0x2u) != 0U);
    config.opMode.stop = ((cs & 0x1u) != 0U);
