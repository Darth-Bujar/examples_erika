# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
# 15 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
...
# 20 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/quadspi_driver.h" 2
...
# 21 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/quadspi_driver.h" 2
...
# 22 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/quadspi_driver.h" 2
...
# 16 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 2
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 1
# 106 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
static inline void QSPI_DRV_IpTrigger(QuadSPI_Type *baseAddr,
                                      uint8_t seqID,
                                      uint16_t dataSize)
{
    baseAddr->IPCR = (((uint32_t)(((uint32_t)(seqID))<<24u))&0xF000000u)
                    | (((uint32_t)(((uint32_t)(dataSize))<<0u))&0xFFFFu);
}
                                              ...
                                              uint8_t iofb3IdleValue)
{
    ...
    regValue &= (uint32_t)(~(0x10000u | 0x20000u | 0x40000u | 0x80000u));
    regValue |= ((((uint32_t)(((uint32_t)(iofa2IdleValue))<<16u))&0x10000u) |
                 (((uint32_t)(((uint32_t)(iofa3IdleValue))<<17u))&0x20000u) |
                 (((uint32_t)(((uint32_t)(iofb2IdleValue))<<18u))&0x40000u) |
                 (((uint32_t)(((uint32_t)(iofb3IdleValue))<<19u))&0x80000u));
...
{
    uint32_t regValue = (uint32_t)baseAddr->MCR;
    regValue &= (uint32_t)(~0xCu);
    regValue |= (((uint32_t)(((uint32_t)(endianess))<<2u))&0xCu);
    baseAddr->MCR = (uint32_t)regValue;
}
...
static inline void QSPI_DRV_SetDozeMode(QuadSPI_Type *baseAddr, 
# 239 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
                                                               _Bool 
# 239 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                                                                    enable)
{
    uint32_t regValue = (uint32_t)baseAddr->MCR;
    regValue &= (uint32_t)(~0x8000u);
    regValue |= (((uint32_t)(((uint32_t)(enable))<<15u))&0x8000u);
    baseAddr->MCR = (uint32_t)regValue;
}
...
{
    uint32_t regValue = (uint32_t)baseAddr->MCR;
    regValue &= (uint32_t)(~0xFF000000u);
    regValue |= (((uint32_t)(((uint32_t)(option))<<24u))&0xFF000000u);
    baseAddr->MCR = (uint32_t)regValue;
}
...
static inline void QSPI_DRV_SetMemMap(QuadSPI_Type *baseAddr, qspi_flash_side_t side, uint32_t size)
{
    ...
    {
        baseAddr->SFA1AD = 0x68000000U + size + 1U;
        baseAddr->SFA2AD = 0x68000000U + size + 1U;
    }
    else
    {
        baseAddr->SFA1AD = 0x68000000U;
        baseAddr->SFA2AD = 0x68000000U;
    }
    baseAddr->SFB1AD = 0x68000000U + size + 1U;
    baseAddr->SFB2AD = 0x68000000U + size + 1U;
}
...
static inline void QSPI_DRV_SetCsHoldTime(QuadSPI_Type *baseAddr, uint8_t cycles)
{
    ...
    regValue &= (uint32_t)(~(0xF00u));
    regValue |= (((uint32_t)(((uint32_t)(cycles))<<8u))&0xF00u);
...
{
    uint32_t regValue = (uint32_t)baseAddr->FLSHCR;
    regValue &= (uint32_t)(~(0xFu));
    regValue |= (((uint32_t)(((uint32_t)(cycles))<<0u))&0xFu);
    baseAddr->FLSHCR = (uint32_t)regValue;
}
...
# 319 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
                                      _Bool 
# 319 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                                           highPriority)
{
    baseAddr->BUF0CR = (((uint32_t)(((uint32_t)(size >> 3U))<<8u))&0xFF00u)
                      | (((uint32_t)(((uint32_t)(master))<<0u))&0xFu)
                      | (((uint32_t)(((uint32_t)(highPriority))<<31u))&0x80000000u);
}
...
static inline void QSPI_DRV_SetAhbBuf1(QuadSPI_Type *baseAddr,
                                       ...
                                       uint8_t master)
{
    baseAddr->BUF1CR = (((uint32_t)(((uint32_t)(size >> 3U))<<8u))&0xFF00u)
                      | (((uint32_t)(((uint32_t)(master))<<0u))&0xFu);
}
...
static inline void QSPI_DRV_SetAhbBuf2(QuadSPI_Type *baseAddr,
                                       ...
                                       uint8_t master)
{
    baseAddr->BUF2CR = (((uint32_t)(((uint32_t)(size >> 3U))<<8u))&0xFF00u)
                      | (((uint32_t)(((uint32_t)(master))<<0u))&0xFu);
}
...
# 357 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
                                      _Bool 
# 357 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                                           allMasters)
{
    baseAddr->BUF3CR = (((uint32_t)(((uint32_t)(size >> 3U))<<8u))&0xFF00u)
                      | (((uint32_t)(((uint32_t)(master))<<0u))&0xFu)
                      | (((uint32_t)(((uint32_t)(allMasters))<<31u))&0x80000000u);
}
...
static inline void QSPI_DRV_SetIpAddr(QuadSPI_Type *baseAddr,
                                      uint32_t addr)
{
    baseAddr->SFAR = 0x68000000U + addr;
}
...
# 410 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
                                          _Bool 
# 410 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                                               wordAdressable)
{
    baseAddr->SFACR = (((uint32_t)(((uint32_t)(columnAddr))<<0u))&0xFu)
                    | (((uint32_t)(((uint32_t)(wordAdressable))<<16u))&0x10000u);
}
...
{
    baseAddr->SMPR = (((uint32_t)(((uint32_t)(clockPhase))<<5u))&0x20u)
                   | (((uint32_t)(((uint32_t)(delay))<<6u))&0x40u);
}
...
static inline 
# 432 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
             _Bool 
# 432 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                  QSPI_DRV_GetBusyStatus(const QuadSPI_Type *baseAddr)
{
    uint32_t regValue = (uint32_t)baseAddr->SR;
    regValue = (regValue & 0x1u) >> 0u;
    return (
# 436 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
           _Bool
# 436 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
               )regValue;
}
...
static inline 
# 454 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
             _Bool 
# 454 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                  QSPI_DRV_GetRxDataEvent(const QuadSPI_Type *baseAddr)
{
    uint32_t regValue = (uint32_t)baseAddr->SR;
    regValue = (regValue & 0x10000u) >> 16u;
    return (
# 458 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
           _Bool
# 458 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
               )regValue;
}
...
static inline 
# 477 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
             _Bool 
# 477 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
                  QSPI_DRV_GetTxWatermarkAvailable(const QuadSPI_Type *baseAddr)
{
    uint32_t regValue = (uint32_t)baseAddr->SR;
    regValue = (regValue & 0x2000000u) >> 25u;
    return (
# 481 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h" 3 4
           _Bool
# 481 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_hw_access.h"
               )regValue;
}
...
{
    baseAddr->RSER &= ~(0x2000000u | 0x200000u);
}
                                           ...
                                           uint8_t watermark)
{
    ...
    regValue &= (uint32_t)(~(0x1Fu));
    regValue |= (((uint32_t)(((uint32_t)(watermark - 1U))<<0u))&0x1Fu);
                                            ...
                                            uint8_t readout)
{
    ...
    regValue |= (((uint32_t)(((uint32_t)(readout))<<8u))&0x100u);
    baseAddr->RBCT = (uint32_t)regValue;
}
                                           ...
                                           uint8_t watermark)
{
    ...
    regValue &= (uint32_t)(~(0x1Fu));
    regValue |= (((uint32_t)(((uint32_t)(watermark))<<0u))&0x1Fu);
...
# 17 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 2
...
# 18 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 2
...
# 19 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 2
...
# 20 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 2
# 90 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
QuadSPI_Type * const g_qspiBase[(1u)] = { ((QuadSPI_Type *)(0x40076000u)) };


static qspi_state_t * g_qspiStatePtr[(1u)] = {
# 93 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                               ((void *)0)
# 93 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                                   };


static const IRQn_Type g_qspiIrqId[(1u)] = { QSPI_IRQn };


void QSPI_IRQHandler(void);
# 112 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static 
# 112 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
      _Bool 
# 112 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
           QSPI_DRV_Timeout(uint32_t startTime, uint32_t timeout)
{
    uint32_t currentTime;
    
# 115 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
   _Bool 
# 115 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
        retVal;
...
# 120 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                      1
# 120 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                          :
# 120 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                           0
# 120 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
...
# 125 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                                          1
# 125 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                                              :
# 125 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                                               0
# 125 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
...
# 137 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static inline status_t QSPI_DRV_ProcessData(uint32_t value, qspi_state_t * state)
{
    status_t status = STATUS_SUCCESS;

    if (state->data != 
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                      ((void *)0)
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                          )
    {
...
# 147 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                             ((void *)0)
# 147 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                 )
    {
...
# 175 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static inline status_t QSPI_DRV_ProcessLastData(uint32_t value, qspi_state_t * state)
{
    ...
    dataSize = state->size;
    if (state->data != 
# 182 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                      ((void *)0)
# 182 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                          )
    {
...
# 192 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                             ((void *)0)
# 192 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                 )
    {
...
# 224 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
...
# 246 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
...
# 286 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static inline status_t QSPI_DRV_ErrorCheck(QuadSPI_Type *baseAddr)
{
    if ((baseAddr->FR & (0x4000000u | 0x800000u | 0x20000u | 0x80u | 0x40u | 0x0u)) != 0U)
    {

        baseAddr->FR = (0x4000000u | 0x800000u | 0x20000u | 0x80u | 0x40u | 0x0u);
        return STATUS_ERROR;
    }
    return STATUS_SUCCESS;

}
# 306 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static inline void QSPI_DRV_PadTxBuf(QuadSPI_Type *baseAddr)
{
    uint32_t bufFill;

    bufFill = QSPI_DRV_GetTxBufFill(baseAddr);
    while ((bufFill < 4U) || ((bufFill & 3U) != 0U))
    {
        QSPI_DRV_WriteTxData(baseAddr, 0xFFFFFFFFU);
        bufFill++;
    }
}
# 325 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
...
static void QSPI_DRV_ConfigureChipOptions(QuadSPI_Type *baseAddr, const qspi_user_config_t * userConfigPtr)
{
    ...
    if (userConfigPtr->readMode == QSPI_READ_MODE_LOOPBACK_DQS)
    {
        ...
        option |= (uint8_t)(0x01U | 0x04U);
    }
    if (userConfigPtr->dqsInvert == 
# 367 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                   1
# 367 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                       )
    {
        option |= (uint8_t)(0x08U | 0x02U);
    }
    QSPI_DRV_SetClockOptions(baseAddr, option);



    QSPI_DRV_SetChipOptions(baseAddr, 0x10000000u);
    chipOption |= (((uint32_t)(((uint32_t)((uint32_t)userConfigPtr->divider - 1U))<<29u))&0xE0000000u);
    chipOption |= ((uint32_t)userConfigPtr->dqsDelay << 0u) +
                  ((uint32_t)userConfigPtr->dqsDelay << 8u);

    QSPI_DRV_SetChipOptions(baseAddr, chipOption | 0x10000000u);

    QSPI_DRV_SetChipOptions(baseAddr, chipOption);
}
# 393 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static void QSPI_DRV_IRQHandler(uint32_t instance)
{
    ...
    QSPI_DRV_DisableInt(baseAddr, 0x1u);


    if (state->operation != 0U)
    {
        state->driverBusy = 
# 432 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                           0
# 432 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                ;
        if (state->callback != 
# 433 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                              ((void *)0)
# 433 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                  )
        {
...
# 448 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
void QSPI_IRQHandler(void)
{
    QSPI_DRV_IRQHandler(0U);
}
# 461 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static void QSPI_DRV_EndDmaTransfer(void *stateStruct, edma_chn_status_t status)
{
    ...
    {
        state->driverBusy = 
# 480 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                           0
# 480 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                ;
        if (state->callback != 
# 481 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                              ((void *)0)
# 481 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                  )
        {
...
# 495 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static void QSPI_DRV_ConfigDmaRx(uint32_t instance, qspi_state_t * state)
{
    QuadSPI_Type *baseAddr;

    static const uint8_t g_qspiDmaRxSrc[(1u)] = {(uint8_t)EDMA_REQ_QUADSPI_RX};
    ...
    (void)EDMA_DRV_SetChannelRequestAndTrigger(state->dmaChannel, g_qspiDmaRxSrc[instance], 
# 507 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                                                           0
# 507 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                                                                );
    ...
    (void)EDMA_DRV_ConfigMultiBlockTransfer(state->dmaChannel,
                                            ...
                                            4U, state->size >> 2U, 
# 515 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                                  1
# 515 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                                      );
...
# 536 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
static void QSPI_DRV_ConfigDmaTx(uint32_t instance, qspi_state_t * state)
{
    QuadSPI_Type *baseAddr;

    static const uint8_t g_qspiDmaTxSrc[(1u)] = {(uint8_t)EDMA_REQ_QUADSPI_TX};
    ...
    (void)EDMA_DRV_SetChannelRequestAndTrigger(state->dmaChannel, g_qspiDmaTxSrc[instance], 
# 548 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                                                           0
# 548 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                                                                );
    ...
    (void)EDMA_DRV_ConfigMultiBlockTransfer(state->dmaChannel,
                                            ...
                                            EDMA_TRANSFER_SIZE_4B,
                                            4U, state->size >> 2U, 
# 556 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                                                  1
# 556 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                                                      );
...
# 585 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_Init(uint32_t instance,
                       const qspi_user_config_t * userConfigPtr,
                       qspi_state_t * state)
{
    ...
    state->driverBusy = 
# 605 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                       0
# 605 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                            ;
    ...
    QSPI_DRV_SetRxBufReadout(baseAddr, 1U);
...
# 680 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_Deinit(uint32_t instance)
{
    QuadSPI_Type *baseAddr;
    ...
    g_qspiStatePtr[instance] = 
# 693 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                              ((void *)0)
# 693 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                  ;

    return STATUS_SUCCESS;
}
# 706 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_AhbSetup(uint32_t instance, const qspi_ahb_config_t *config)
{
    QuadSPI_Type *baseAddr;
...
# 740 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_IpCommand(uint32_t instance, uint8_t lut, uint32_t timeout)
{
    ((void)0);
    QuadSPI_Type *baseAddr;
...
# 777 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_IpRead(uint32_t instance,
                         uint8_t lut,
                         uint32_t addr,
                         uint8_t * dataRead,
                         ...
                         uint32_t timeout)
{
    ...
    {
        state->driverBusy = 
# 808 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                           1
# 808 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                               ;
        ...
        else
        {
            ...
            QSPI_DRV_ClearIntFlag(baseAddr, 0x1u);

            QSPI_DRV_EnableInt(baseAddr, 0x1u);
...
# 870 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_IpWrite(uint32_t instance,
                          uint8_t lut,
                          uint32_t addr,
                          const uint8_t * data,
                          ...
                          uint32_t timeout)
{
    ...
    if ((transferType == QSPI_TRANSFER_TYPE_ASYNC_DMA) && (state->size > 128U))
    {

        QSPI_DRV_FillTxBuf(baseAddr, state, (uint16_t)((128U >> 2U) - 1U));
    ...
    else
    {
        ...
        QSPI_DRV_FillTxBuf(baseAddr, state, 128U >> 2U);
    ...
    {
        state->driverBusy = 
# 923 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                           1
# 923 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                               ;
...
# 968 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_IpErase(uint32_t instance,
                          uint8_t lut,
                          uint32_t addr)
{
...
# 999 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_IpGetStatus(uint32_t instance)
{
    qspi_state_t * state;
    QuadSPI_Type *baseAddr;
...
# 1029 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
status_t QSPI_DRV_GetDefaultConfig(qspi_user_config_t * userConfigPtr)
{
    userConfigPtr->dataRate = QSPI_DATE_RATE_SDR;
    userConfigPtr->dmaSupport = 
# 1032 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                               0
# 1032 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                    ;

    userConfigPtr->dmaChannel = 0U;

    userConfigPtr->callback = 
# 1036 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                             ((void *)0)
# 1036 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                 ;
    userConfigPtr->callbackParam = 
# 1037 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                  ((void *)0)
# 1037 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                      ;
    userConfigPtr->readMode = QSPI_READ_MODE_INTERNAL_SAMPLING;
    userConfigPtr->side = QSPI_FLASH_SIDE_A;
    userConfigPtr->memSize = 0x7FFFFFU;
    userConfigPtr->csHoldTime = 1U;
    userConfigPtr->csSetupTime = 1U;
    userConfigPtr->columnAddr = 0U;
    userConfigPtr->wordAddresable = 
# 1044 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c" 3 4
                                   0
# 1044 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\quadspi\\quadspi_driver.c"
                                        ;
    userConfigPtr->sampleDelay = QSPI_SAMPLE_DELAY_1;
    userConfigPtr->samplePhase = QSPI_SAMPLE_PHASE_NON_INVERTED;
    userConfigPtr->endianess = QSPI_END_64BIT_LE;
    userConfigPtr->clock_src = QSPI_CLK_SRC_FIRC_DIV1;
