# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
# 67 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 1
# 48 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stdbool.h" 1 3 4
# 49 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 2
...
# 50 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 2
...
# 51 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 2
...
# 52 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 2
# 713 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
typedef enum
{
    EEE_ENABLE = 0x00U,
...
# 772 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
typedef void (* flash_callback_t)(void);
# 786 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
typedef struct
{
    uint32_t PFlashBase;
    uint32_t PFlashSize;
...
# 810 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
typedef struct
{
    uint32_t PFlashBase;
    uint32_t PFlashSize;
...
status_t FLASH_DRV_ProgramCheck(const flash_ssd_config_t * pSSDConfig,
                                ...
                                uint32_t * pFailAddr,
                                uint8_t marginLevel);
# 1196 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_CheckSum(const flash_ssd_config_t * pSSDConfig,
                            uint32_t dest,
                            uint32_t size,
                            uint32_t * pSum);
# 1233 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_ProgramSection(const flash_ssd_config_t * pSSDConfig,
                                  uint32_t dest,
                                  uint16_t number);
# 1259 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_EraseBlock(const flash_ssd_config_t * pSSDConfig,
                              uint32_t dest);
# 1289 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_VerifyBlock(const flash_ssd_config_t * pSSDConfig,
                               uint32_t dest,
                               uint8_t marginLevel);
# 1317 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_GetEERAMProtection(uint8_t * protectStatus);
# 1343 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_SetEERAMProtection(uint8_t protectStatus);
# 1376 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
...
# 1412 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_EEEWrite(const flash_ssd_config_t * pSSDConfig,
                            uint32_t dest,
                            uint32_t size,
                            const uint8_t * pData);
# 1450 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
...
# 1454 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
                                   _Bool 
# 1454 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
                                        uSFE,
                                    
# 1455 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
                                   _Bool 
# 1455 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
                                        flexRamEnableLoadEEEData);
# 1523 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_GetDFlashProtection(const flash_ssd_config_t * pSSDConfig,
                                       uint8_t * protectStatus);
# 1547 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_SetDFlashProtection(const flash_ssd_config_t * pSSDConfig,
                                       uint8_t protectStatus);
# 1666 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
status_t FLASH_DRV_EraseAllBlockUnsecure(const flash_ssd_config_t * pSSDConfig);
# 1678 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
...
# 1695 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
static inline 
# 1695 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
             _Bool 
# 1695 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
                  FLASH_DRV_GetCmdCompleteFlag(void)
{
    return (((((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u) >> 7u) != 0U);
}
# 1709 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
...
# 1726 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
static inline 
# 1726 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
             _Bool 
# 1726 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
                  FLASH_DRV_GetReadColisionFlag(void)
{
    return (((((FTFC_Type *)(0x40020000u))->FSTAT & 0x40u) >> 6u) != 0U);
}
...
{
    ((FTFC_Type *)(0x40020000u))->FSTAT = 0x40u;
}
# 1752 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
...
# 1770 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
static inline 
# 1770 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
             _Bool 
# 1770 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
                  FLASH_DRV_GetDoubleBitFaultFlag(void)
{
    return (((((FTFC_Type *)(0x40020000u))->FERSTAT & 0x2u) >> 1u) != 0U);
}
...
{
    ((FTFC_Type *)(0x40020000u))->FERSTAT = 0x2u;
}
# 1795 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
static inline void FLASH_DRV_ForceDoubleBitFaultDetectCmd(
# 1795 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
                                                         _Bool 
# 1795 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
                                                              isEnable)
{
    if (
# 1797 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h" 3 4
       1 
# 1797 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
            == isEnable)
    {
        ((FTFC_Type *)(0x40020000u))->FERCNFG |= 0x20u;
    }
    else
    {
        ((FTFC_Type *)(0x40020000u))->FERCNFG &= (uint8_t)(~0x20u);
    }
}
# 2015 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/flash_driver.h"
void FLASH_DRV_GetDefaultConfig(flash_user_config_t * const config);
# 68 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c" 2
...
# 69 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c" 2
...
static status_t FLASH_DRV_ProgramCheckExecute(const flash_ssd_config_t * pSSDConfig,
                                              ...
                                              uint32_t * pFailAddr,
                                              uint8_t marginLevel);
# 89 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
                                         ...
                                         uint8_t DEPartitionCode)
{
    ...
    {
        case 0x00U:
            pSSDConfig->DFlashSize = (uint32_t)(0x00080000u);
            break;
        case 0x01U:
            pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);
            break;
        case 0x02U:
            pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);
            break;
        case 0x03U:
            ...
            break;
        case 0x04U:
            pSSDConfig->DFlashSize = (uint32_t)(0x000070000u);
            break;
        case 0x05U:
            pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);
            break;
...
# 225 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_Init(const flash_user_config_t * const pUserConf,
                        flash_ssd_config_t * const pSSDConfig)
{
    ((void)0);
    ...
    DEPartitionCode = (uint8_t)((((SIM_Type *)(0x40048000u))->FCFG1 & 0xF000u) >> 12u);

    FLASH_DRV_GetDEPartitionCode(pSSDConfig, DEPartitionCode);
    if (pSSDConfig->DFlashSize < (524288u))
    {
        pSSDConfig->EEESize = (4096u);
    }
    else
    {
...
# 271 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
...
static status_t FLASH_DRV_CommandSequence(const flash_ssd_config_t * pSSDConfig)
{
    ...
    ((FTFC_Type *)(0x40020000u))->FSTAT |= 0x80u;

    while (0U == (((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u))
    {



        if (((flash_callback_t)0xFFFFFFFFU) != pSSDConfig->CallBack)
        {
    ...
    if ( (((FTFC_Type *)(0x40020000u))->FSTAT & (0x1u | 0x10u | 0x20u | 0x40u)) != 0U)
    {
        ret = STATUS_ERROR;
    }
...
# 314 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_GetPFlashProtection(uint32_t * protectStatus)
{
    ((void)0);
    uint32_t reg0, reg1, reg2, reg3;

    reg0 = ((FTFC_Type *)(0x40020000u))->FPROT[3];
    reg1 = ((FTFC_Type *)(0x40020000u))->FPROT[2];
    reg2 = ((FTFC_Type *)(0x40020000u))->FPROT[1];
    reg3 = ((FTFC_Type *)(0x40020000u))->FPROT[0];

    *protectStatus = (uint32_t)((reg0 << 24U) | (reg1 << 16U) | (reg2 << 8U) | reg3);
}
# 337 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_SetPFlashProtection(uint32_t protectStatus)
{
    status_t ret = STATUS_SUCCESS;
    uint8_t reg0, reg1, reg2, reg3;
    
# 341 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c" 3 4
   _Bool 
# 341 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
        flag0, flag1, flag2, flag3;


    reg0 = ((uint8_t)(((uint32_t)(protectStatus)) >> 24));
    reg1 = ((uint8_t)((((uint32_t)(protectStatus)) >> 16) & 0xFFU));
    reg2 = ((uint8_t)((((uint32_t)(protectStatus)) >> 8) & 0xFFU));
    reg3 = ((uint8_t)(((uint32_t)(protectStatus)) & 0xFFU));


    ((FTFC_Type *)(0x40020000u))->FPROT[3] = reg0;
    ((FTFC_Type *)(0x40020000u))->FPROT[2] = reg1;
    ((FTFC_Type *)(0x40020000u))->FPROT[1] = reg2;
    ((FTFC_Type *)(0x40020000u))->FPROT[0] = reg3;


    flag0 = (((FTFC_Type *)(0x40020000u))->FPROT[3] != reg0);
    flag1 = (((FTFC_Type *)(0x40020000u))->FPROT[2] != reg1);
    flag2 = (((FTFC_Type *)(0x40020000u))->FPROT[1] != reg2);
    flag3 = (((FTFC_Type *)(0x40020000u))->FPROT[0] != reg3);
...
# 378 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_GetSecurityState(uint8_t * securityState)
{
    ((void)0);
    ...
    regValue = ((FTFC_Type *)(0x40020000u))->FSEC;


    if (0x02U == (regValue & 0x3u))
    {
...
# 420 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_SecurityBypass(const flash_ssd_config_t * pSSDConfig,
                                  const uint8_t * keyBuffer)
{
    ((void)0);
    ...
    if (0U == (((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u))
    {
        ret = STATUS_BUSY;
    }
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FSTAT = (uint8_t)(0x10u | 0x20u | 0x40u);


        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x45U;
        for (i = 0U; i < 8U; i++)
        {
            temp = (0x40020000u) + i + 0x08U;
...
# 461 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EraseAllBlock(const flash_ssd_config_t * pSSDConfig)
{
    ((void)0);
    status_t ret;
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x44U;
...
# 495 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_VerifyAllBlock(const flash_ssd_config_t * pSSDConfig,
                                  uint8_t marginLevel)
{
    ((void)0);
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x40U;
        ((FTFC_Type *)(0x40020000u))->FCCOB[2] = marginLevel;
...
# 531 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EraseSector(const flash_ssd_config_t * pSSDConfig,
                               uint32_t dest,
                               uint32_t size)
{
    ...
    while ((tempSize > 0U) && (STATUS_SUCCESS == ret))
    {
        ...
        else
        {
            ...
            ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x09U;
            ((FTFC_Type *)(0x40020000u))->FCCOB[2] = ((uint8_t)((((uint32_t)(dest)) >> 16) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[1] = ((uint8_t)((((uint32_t)(dest)) >> 8) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[0] = ((uint8_t)(((uint32_t)(dest)) & 0xFFU));
...
# 612 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_VerifySection(const flash_ssd_config_t * pSSDConfig,
                                 uint32_t dest,
                                 uint16_t number,
                                 uint8_t marginLevel)
{
    ...
    if (STATUS_SUCCESS == ret)
    {
        ...
        else
        {
            ...
            ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x01U;
            ((FTFC_Type *)(0x40020000u))->FCCOB[2] = ((uint8_t)((((uint32_t)(dest)) >> 16) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[1] = ((uint8_t)((((uint32_t)(dest)) >> 8) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[0] = ((uint8_t)(((uint32_t)(dest)) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[7] = ((uint8_t)((((uint32_t)(number)) >> 8) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[6] = ((uint8_t)(((uint32_t)(number)) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[5] = marginLevel;
...
# 682 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_EraseSuspend(void)
{
    uint32_t count = 0x40U;

    if ((((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u) == 0U)
    {
        ((FTFC_Type *)(0x40020000u))->FCNFG |= 0x10u;


        while (((((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u) == 0U) && (count > 0U))
        {
            count--;
        }
    }
}
# 707 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_EraseResume(void)
{
    uint16_t i = 0U;


    if ((((FTFC_Type *)(0x40020000u))->FCNFG & 0x10u) == 0x10u)
    {

        ((FTFC_Type *)(0x40020000u))->FSTAT |= 0x80u;

        while ((0U == (((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u)) && (i < 0x20U))
        {
            i++;
        }
    }
}
# 732 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_ReadOnce(const flash_ssd_config_t * pSSDConfig,
                            uint8_t recordIndex,
                            uint8_t * pDataArray)
{
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x41U;
        ((FTFC_Type *)(0x40020000u))->FCCOB[2] = recordIndex;
...
# 783 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_ProgramOnce(const flash_ssd_config_t * pSSDConfig,
                               uint8_t recordIndex,
                               const uint8_t * pDataArray)
{
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x43U;
        ((FTFC_Type *)(0x40020000u))->FCCOB[2] = recordIndex;
...
# 908 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_Program(const flash_ssd_config_t * pSSDConfig,
                           uint32_t dest,
                           uint32_t size,
                           const uint8_t * pData)
    ...
    else
    {
        ...
        while ((size > 0U) && (STATUS_SUCCESS == ret))
        {
            ...
            else
            {
                ...
                ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x07U;
...
# 1000 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_ProgramCheck(const flash_ssd_config_t * pSSDConfig,
                                uint32_t dest,
                                uint32_t size,
                                const uint8_t * pExpectedData,
...
# 1041 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_CheckSum(const flash_ssd_config_t * pSSDConfig,
                            uint32_t dest,
                            uint32_t size,
                            uint32_t * pSum)
...
# 1115 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_ProgramSection(const flash_ssd_config_t * pSSDConfig,
                                  uint32_t dest,
                                  uint16_t number)
{
    ...
    if (0U == (((FTFC_Type *)(0x40020000u))->FCNFG & 0x2u))
    {
    ...
    else
    {
        ...
        if (ret == STATUS_SUCCESS)
        {
            ...
            else
            {
                ...
                ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x0BU;
                ((FTFC_Type *)(0x40020000u))->FCCOB[2] = ((uint8_t)((((uint32_t)(dest)) >> 16) & 0xFFU));
                ((FTFC_Type *)(0x40020000u))->FCCOB[1] = ((uint8_t)((((uint32_t)(dest)) >> 8) & 0xFFU));
                ((FTFC_Type *)(0x40020000u))->FCCOB[0] = ((uint8_t)(((uint32_t)(dest)) & 0xFFU));
                ((FTFC_Type *)(0x40020000u))->FCCOB[7] = ((uint8_t)((((uint32_t)(number)) >> 8) & 0xFFU));
...
# 1194 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EraseBlock(const flash_ssd_config_t * pSSDConfig,
                              uint32_t dest)
{
    ((void)0);
    ...
    if (STATUS_SUCCESS == ret)
    {
        ...
        else
        {
            ...
            ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x08U;
            ((FTFC_Type *)(0x40020000u))->FCCOB[2] = ((uint8_t)((((uint32_t)(dest)) >> 16) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[1] = ((uint8_t)((((uint32_t)(dest)) >> 8) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[0] = ((uint8_t)(((uint32_t)(dest)) & 0xFFU));
...
# 1261 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_VerifyBlock(const flash_ssd_config_t * pSSDConfig,
                               uint32_t dest,
                               uint8_t marginLevel)
{
    ...
    if (STATUS_SUCCESS == ret)
    {
        ...
        else
        {
            ...
            ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x00U;
            ((FTFC_Type *)(0x40020000u))->FCCOB[2] = ((uint8_t)((((uint32_t)(dest)) >> 16) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[1] = ((uint8_t)((((uint32_t)(dest)) >> 8) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[0] = ((uint8_t)(((uint32_t)(dest)) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[7] = marginLevel;
...
# 1331 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_GetEERAMProtection(uint8_t * protectStatus)
{
    ((void)0);
    status_t ret = STATUS_SUCCESS;
    ...
    if ((((FTFC_Type *)(0x40020000u))->FCNFG & 0x1u) == 0x1u)
    {
        *protectStatus = ((FTFC_Type *)(0x40020000u))->FEPROT;
    }
    else
    {
        ret = STATUS_UNSUPPORTED;
...
# 1359 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_SetEERAMProtection(uint8_t protectStatus)
{
    status_t ret = STATUS_SUCCESS;


    if (0U == (((FTFC_Type *)(0x40020000u))->FCNFG & 0x1u))
    {
    ...
    {
        ((FTFC_Type *)(0x40020000u))->FEPROT = protectStatus;
        if (protectStatus != ((FTFC_Type *)(0x40020000u))->FEPROT)
        {
            ret = STATUS_ERROR;
        }
        else
...
# 1399 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_SetFlexRamFunction(const flash_ssd_config_t * pSSDConfig,
                                      flash_flexRam_function_control_code_t flexRamFuncCode,
                                      uint16_t byteOfQuickWrite,
                                      flash_eeprom_status_t * const pEEPROMStatus)
{
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x81U;
        ((FTFC_Type *)(0x40020000u))->FCCOB[2] = (uint8_t)flexRamFuncCode;

        if (flexRamFuncCode == EEE_QUICK_WRITE)
        {
            ((FTFC_Type *)(0x40020000u))->FCCOB[7] = (uint8_t)(byteOfQuickWrite >> 0x8U);
            ((FTFC_Type *)(0x40020000u))->FCCOB[6] = (uint8_t)(byteOfQuickWrite & 0xFFU);
        }
        ...
        {
            if (pEEPROMStatus == 
# 1432 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c" 3 4
                                ((void *)0)
# 1432 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
                                    )
            {
                ret = STATUS_ERROR;
            }
            ...
            {
                pEEPROMStatus->brownOutCode = ((FTFC_Type *)(0x40020000u))->FCCOB[6];
                pEEPROMStatus->sectorEraseCount = (uint16_t)((uint16_t)((FTFC_Type *)(0x40020000u))->FCCOB[11] << 8U);
                pEEPROMStatus->sectorEraseCount |= (uint16_t)((FTFC_Type *)(0x40020000u))->FCCOB[10];
                pEEPROMStatus->numOfRecordReqMaintain = (uint16_t)((uint16_t)((FTFC_Type *)(0x40020000u))->FCCOB[5] << 8U);
                pEEPROMStatus->numOfRecordReqMaintain |= (uint16_t)((FTFC_Type *)(0x40020000u))->FCCOB[4];
            }
        }
    }
                                              ...
                                              uint8_t step)
{
    ...
    status_t ret = STATUS_SUCCESS;
    uint32_t temp;
# 1495 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
    if (0x04U == step)
    {
    ...
    while (0U == (((FTFC_Type *)(0x40020000u))->FCNFG & 0x1u))
    {
...
# 1563 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EEEWrite(const flash_ssd_config_t * pSSDConfig,
                            uint32_t dest,
                            uint32_t size,
                            const uint8_t * pData)
{
    ...
    if ((((FTFC_Type *)(0x40020000u))->FCNFG & 0x1u) == 0x1u)
    {
        ...
        {
# 1599 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
...
# 1643 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_DEFlashPartition(const flash_ssd_config_t * pSSDConfig,
                                    uint8_t uEEEDataSizeCode,
                                    uint8_t uDEPartitionCode,
                                    uint8_t uCSEcKeySize,
                                    
# 1647 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c" 3 4
                                   _Bool 
# 1647 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
                                        uSFE,
                                    
# 1648 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c" 3 4
                                   _Bool 
# 1648 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
                                        flexRamEnableLoadEEEData)
{
    ((void)0);
    ((void)0);
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x80U;
        ((FTFC_Type *)(0x40020000u))->FCCOB[2] = uCSEcKeySize;
        ((FTFC_Type *)(0x40020000u))->FCCOB[1] = (uint8_t)(uSFE ? 1U : 0U);
        ((FTFC_Type *)(0x40020000u))->FCCOB[0] = (uint8_t)(flexRamEnableLoadEEEData ? 0U : 1U);
        ((FTFC_Type *)(0x40020000u))->FCCOB[7] = uEEEDataSizeCode;
        ((FTFC_Type *)(0x40020000u))->FCCOB[6] = uDEPartitionCode;
...
# 1741 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_GetDFlashProtection(const flash_ssd_config_t * pSSDConfig,
                                       uint8_t * protectStatus)
{
    ((void)0);
    ...
    {
        *protectStatus = ((FTFC_Type *)(0x40020000u))->FDPROT;
    }

    return ret;
}
# 1771 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_SetDFlashProtection(const flash_ssd_config_t * pSSDConfig,
                                       uint8_t protectStatus)
{
    ((void)0);
    ...
    {
        ((FTFC_Type *)(0x40020000u))->FDPROT = protectStatus;
        if (protectStatus != ((FTFC_Type *)(0x40020000u))->FDPROT)
        {
            ret = STATUS_ERROR;
        }
        else
...
# 2005 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EraseAllBlockUnsecure(const flash_ssd_config_t * pSSDConfig)
{
    ((void)0);
    status_t ret;
    ...
    else
    {
        ...
        ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x49U;
...
# 2039 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EnableCmdCompleteInterupt(void)
{
    const IRQn_Type flashIrqId = { FTFC_IRQn };


    ((FTFC_Type *)(0x40020000u))->FCNFG |= 0x80u;
    INT_SYS_EnableIRQ(flashIrqId);

    return STATUS_SUCCESS;
}
# 2057 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_DisableCmdCompleteInterupt(void)
{
    const IRQn_Type flashIrqId = { FTFC_IRQn };


    ((FTFC_Type *)(0x40020000u))->FCNFG &= (uint8_t)(~0x80u);
    INT_SYS_DisableIRQ(flashIrqId);
}
# 2074 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EnableReadColisionInterupt(void)
{
    const IRQn_Type flashIrqId = { Read_Collision_IRQn };


    ((FTFC_Type *)(0x40020000u))->FCNFG |= 0x40u;
    INT_SYS_EnableIRQ(flashIrqId);

    return STATUS_SUCCESS;
}
# 2092 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_DisableReadColisionInterupt(void)
{
    const IRQn_Type flashIrqId = { Read_Collision_IRQn };


    ((FTFC_Type *)(0x40020000u))->FCNFG &= (uint8_t)(~0x40u);
    INT_SYS_DisableIRQ(flashIrqId);
}
# 2111 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
status_t FLASH_DRV_EnableDoubleBitFaultInterupt(void)
{

    ((FTFC_Type *)(0x40020000u))->FERCNFG |= 0x2u;
...
# 2130 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_DisableDoubleBitFaultInterupt(void)
{

    ((FTFC_Type *)(0x40020000u))->FERCNFG &= (uint8_t)(~0x2u);
...
# 2244 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
void FLASH_DRV_GetDefaultConfig(flash_user_config_t * const config)
{
    ((void)0);

    config->PFlashBase = 0x00000000U;
    config->PFlashSize = (0x180000U);
    config->DFlashBase = 0x10000000U;
    config->EERAMBase = 0x14000000U;
    config->CallBack = ((flash_callback_t)0xFFFFFFFFU);
}
# 2265 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flash\\flash_driver.c"
static status_t FLASH_DRV_ProgramCheckExecute(const flash_ssd_config_t * pSSDConfig,
                                              uint32_t dest,
                                              uint32_t size,
                                              const uint8_t * pExpectedData,
                                              ...
                                              uint8_t marginLevel)
{
    ...
    while ((tempSize > 0U) && (STATUS_SUCCESS == ret))
    {
        ...
        else
        {
            ...
            ((FTFC_Type *)(0x40020000u))->FCCOB[3] = 0x02U;
            ((FTFC_Type *)(0x40020000u))->FCCOB[2] = ((uint8_t)((((uint32_t)(dest)) >> 16) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[1] = ((uint8_t)((((uint32_t)(dest)) >> 8) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[0] = ((uint8_t)(((uint32_t)(dest)) & 0xFFU));
            ((FTFC_Type *)(0x40020000u))->FCCOB[7] = marginLevel;
