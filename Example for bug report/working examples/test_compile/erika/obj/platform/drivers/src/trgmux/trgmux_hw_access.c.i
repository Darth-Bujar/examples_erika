# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
# 31 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
...
# 32 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 2
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.h" 1
# 20 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h" 1
# 41 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
...
# 42 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h" 2
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stdbool.h" 1 3 4
# 43 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h" 2
...
# 44 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h" 2
...
# 45 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h" 2
# 68 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
typedef enum trgmux_trigger_source_e trgmux_trigger_source_t;
# 78 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
typedef enum trgmux_target_module_e trgmux_target_module_t;
# 88 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
typedef struct
{
    trgmux_trigger_source_t triggerSource;
    trgmux_target_module_t targetModule;
    
# 92 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h" 3 4
   _Bool 
# 92 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
        lockTargetModuleReg;

} trgmux_inout_mapping_config_t;
# 104 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
typedef struct
{
    uint8_t numInOutMappingConfigs;
    const trgmux_inout_mapping_config_t * inOutMappingConfig;
} trgmux_user_config_t;
# 147 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
status_t TRGMUX_DRV_Init(const uint32_t instance,
                         const trgmux_user_config_t * const trgmuxUserConfig);
# 159 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
status_t TRGMUX_DRV_Deinit(const uint32_t instance);
# 173 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/trgmux_driver.h"
...
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
    ...
    while ((count < ((uint8_t)(sizeof(s_trgmuxTargetModule) / sizeof(trgmux_target_module_t)))) && (lock != 
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 3 4
                                                          1
# 66 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
                                                              ))
    {
    ...
    if (lock == 
# 73 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 3 4
               0
# 73 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
                    )
    {

        for (count = 0U; count < ((uint8_t)(sizeof(s_trgmuxTargetModule) / sizeof(trgmux_target_module_t))); count++)
        {

            base->TRGMUXn[((uint8_t)((uint8_t)(s_trgmuxTargetModule[count]) / (4U)))] &=
                ~((uint32_t)0x7Fu << (8u * ((uint8_t)((uint8_t)(s_trgmuxTargetModule[count]) % (4U)))));
        }
...
# 96 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
void TRGMUX_SetTrigSourceForTargetModule(TRGMUX_Type * const base,
                                         const trgmux_trigger_source_t triggerSource,
                                         const trgmux_target_module_t targetModule)
{
    ...
    tmpReg = base->TRGMUXn[((uint8_t)((uint8_t)(targetModule) / (4U)))];

    tmpReg &= ~((uint32_t)0x7Fu << (8u * ((uint8_t)((uint8_t)(targetModule) % (4U)))));

    tmpReg |= ((uint32_t)triggerSource) << ((uint8_t)(8u * ((uint8_t)((uint8_t)(targetModule) % (4U)))));

    base->TRGMUXn[((uint8_t)((uint8_t)(targetModule) / (4U)))] = tmpReg;
}
# 120 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
trgmux_trigger_source_t TRGMUX_GetTrigSourceForTargetModule(const TRGMUX_Type * const base,
                                                            const trgmux_target_module_t targetModule)
{
    ((void)0);
    ...
    trigSource =
        ((base->TRGMUXn[((uint8_t)((uint8_t)(targetModule) / (4U)))] >> (8u * ((uint8_t)((uint8_t)(targetModule) % (4U))))) & 0x7Fu);

    return (trgmux_trigger_source_t)(trigSource);
}
# 140 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
void TRGMUX_SetLockForTargetModule(TRGMUX_Type * const base,
                                   const trgmux_target_module_t targetModule)
{
    ((void)0);
    ...
    base->TRGMUXn[((uint8_t)((uint8_t)(targetModule) / (4U)))] |= (((uint32_t)1U) << 31u);
}
...
# 155 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 3 4
_Bool 
# 155 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
    TRGMUX_GetLockForTargetModule(const TRGMUX_Type * const base,
                                   const trgmux_target_module_t targetModule)
{
    ((void)0);
...
# 161 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 3 4
   _Bool 
# 161 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
        lock;


    lockVal = ((base->TRGMUXn[((uint8_t)((uint8_t)(targetModule) / (4U)))] & 0x80000000u) >> 31u);

    lock = (lockVal == 0U) ? 
# 166 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 3 4
                            0 
# 166 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
                                  : 
# 166 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c" 3 4
                                    1
# 166 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.c"
