# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c"
# 23 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c"
...
# 24 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c" 2
# 39 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c"
static inline uint8_t BIT(uint8_t A,
                          uint8_t B)
{
    return (uint8_t)((A >> B) & 0x01U);
}
# 55 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c"
uint8_t LIN_DRV_ProcessParity(uint8_t PID,
                              uint8_t typeAction)
{
    uint8_t parity;
...
# 100 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_common.c"
uint8_t LIN_DRV_MakeChecksumByte(const uint8_t * buffer,
                                 uint8_t sizeBuffer,
                                 uint8_t PID)
{
