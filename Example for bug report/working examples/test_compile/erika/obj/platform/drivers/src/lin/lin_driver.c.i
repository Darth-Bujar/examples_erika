# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
# 29 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/lin_driver.h" 1
# 33 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/lin_driver.h"
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stdbool.h" 1 3 4
# 34 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/lin_driver.h" 2
...
# 36 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/lin_driver.h" 2
...
# 37 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/lin_driver.h" 2
...
# 38 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/lin_driver.h" 2
...
# 30 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c" 2
...
# 32 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c" 2
# 59 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_Init(uint32_t instance,
                      lin_user_config_t * linUserConfig,
                      lin_state_t * linCurrentState)
{
...
# 80 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
void LIN_DRV_Deinit(uint32_t instance)
{
...
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
void LIN_DRV_GetDefaultConfig(
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c" 3 4
                             _Bool 
# 95 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
                                  isMaster,
                              lin_user_config_t * linUserConfig)
...
# 111 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
lin_callback_t LIN_DRV_InstallCallback(uint32_t instance,
                                       lin_callback_t function)
{
    lin_callback_t retVal = 
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c" 3 4
                           ((void *)0)
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
                               ;
...
# 137 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_SendFrameDataBlocking(uint32_t instance,
                                       const uint8_t * txBuff,
                                       uint8_t txSize,
                                       uint32_t timeoutMSec)
...
# 162 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_SendFrameData(uint32_t instance,
                               const uint8_t * txBuff,
                               uint8_t txSize)
{
...
# 187 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_GetTransmitStatus(uint32_t instance,
                                   uint8_t * bytesRemaining)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 214 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_ReceiveFrameDataBlocking(uint32_t instance,
                                          uint8_t * rxBuff,
                                          uint8_t rxSize,
                                          uint32_t timeoutMSec)
...
# 244 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_ReceiveFrameData(uint32_t instance,
                                  uint8_t * rxBuff,
                                  uint8_t rxSize)
{
...
# 266 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_AbortTransferData(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 289 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_GetReceiveStatus(uint32_t instance,
                                  uint8_t * bytesRemaining)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 309 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_GoToSleepMode(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 327 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_GotoIdleState(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 345 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_SendWakeupSignal(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 363 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
lin_node_state_t LIN_DRV_GetCurrentNodeState(uint32_t instance)
{
...
# 383 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
void LIN_DRV_TimeoutService(uint32_t instance)
{
...
# 398 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
void LIN_DRV_SetTimeoutCounter(uint32_t instance,
                               uint32_t timeoutValue)
{
...
# 418 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_MasterSendHeader(uint32_t instance,
                                  uint8_t id)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 437 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_EnableIRQ(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 455 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_DisableIRQ(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
...
# 475 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
void LIN_DRV_IRQHandler(uint32_t instance)
{
...
# 493 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lin\\lin_driver.c"
status_t LIN_DRV_AutoBaudCapture(uint32_t instance)
{
    status_t retVal = STATUS_UNSUPPORTED;
