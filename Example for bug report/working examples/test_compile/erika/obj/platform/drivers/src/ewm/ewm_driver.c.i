# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
# 36 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
...
# 37 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c" 2
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h" 1
# 23 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h" 1
# 23 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
...
# 24 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h" 2
...
# 25 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h" 2
# 40 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
typedef enum
{
...
# 54 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
typedef struct
{
    ewm_in_assert_logic_t assertLogic;
    
# 57 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h" 3 4
   _Bool 
# 57 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
              interruptEnable;
    uint8_t prescaler;
    uint8_t compareLow;
    uint8_t compareHigh;
} ewm_init_config_t;
# 107 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
status_t EWM_DRV_Init(uint32_t instance, const ewm_init_config_t * config);
# 117 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
void EWM_DRV_GetDefaultConfig(ewm_init_config_t * config);
# 128 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
void EWM_DRV_Refresh(uint32_t instance);
# 138 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ewm_driver.h"
ewm_in_assert_logic_t EWM_DRV_GetInputPinAssertLogic(uint32_t instance);
# 24 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h" 2
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
...
# 72 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
static inline 
# 72 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h" 3 4
             _Bool 
# 72 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
                  EWM_IsEnabled(const EWM_Type * const base)
{
    return ((base->CTRL & 0x1u) >> 0u) != 0U;
}
# 85 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
...
# 110 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
static inline void EWM_SetCompareLow(EWM_Type * const base, uint8_t value)
{
    base->CMPL = value;
}
# 126 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
static inline void EWM_SetCompareHigh(EWM_Type * const base, uint8_t value)
{
    base->CMPH = value;
}
# 141 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_hw_access.h"
static inline void EWM_SetPrescaler(EWM_Type * const base, uint8_t value)
{
    base->CLKPRESCALER = value;
}
# 38 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c" 2
...
# 39 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c" 2


static EWM_Type * const s_ewmBase[] = { ((EWM_Type *)(0x40061000u)) };
# 60 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
status_t EWM_DRV_Init(uint32_t instance, const ewm_init_config_t * config)
{
    ((void)0);
    ((void)0);
...
# 68 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c" 3 4
   _Bool 
# 68 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
        isModuleEnabled;
    ...
    if ((isModuleEnabled == 
# 76 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c" 3 4
                           1
# 76 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
                               ) || (config->compareHigh <= config->compareLow) ||
        (config->compareHigh > (0xFEU)))
    {
    ...
    else
    {
        ...
        tempValue = (uint8_t)((uint8_t)(((uint8_t)(((uint8_t)(1U))<<0u))&0x1u) | (((uint8_t)(((uint8_t)(config->interruptEnable ? 1U : 0U))<<3u))&0x8u));
...
# 128 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
void EWM_DRV_GetDefaultConfig(ewm_init_config_t * config)
{
    ((void)0);
...
# 133 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c" 3 4
                             0
# 133 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
                                  ;
    ...
    config->compareHigh = (0xFEU);
    config->compareLow = (0x00U);
}
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
void EWM_DRV_Refresh(uint32_t instance)
{
    ((void)0);
...
# 172 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ewm\\ewm_driver.c"
ewm_in_assert_logic_t EWM_DRV_GetInputPinAssertLogic(uint32_t instance)
{
    ((void)0);
    ...
    if ((EWM_GetControl(base) & 0x4u) != 0U)
    {

        returnValue = (((EWM_GetControl(base) & 0x2u) != 0U)
