# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
# 20 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
...
# 21 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 2
# 31 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
void EDMA_Init(DMA_Type * base)
{
    uint8_t i;
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    uint32_t regValTemp;
    regValTemp = base->CR;
    regValTemp &= ~(0x40u);
    regValTemp &= ~(0x20000u);
...
{
    uint32_t regValTemp;
# 88 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    regValTemp = base->CR;
    regValTemp &= ~(0x20000u);
...
{
    uint32_t regValTemp;
# 113 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    regValTemp = base->CR;
    regValTemp &= ~(0x10000u);
...
void EDMA_SetErrorIntCmd(DMA_Type * base, uint8_t channel, 
# 127 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                                                          _Bool 
# 127 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
                                                               enable)
{
# 142 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    if (enable)
    {
        base->SEEI = channel;
    }
...
void EDMA_SetDmaRequestCmd(DMA_Type * base, uint8_t channel,
# 158 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                                                           _Bool 
# 158 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
                                                                enable)
{
# 173 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    if (enable)
    {
        base->SERQ = channel;
    }
...
# 226 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
void EDMA_TCDClearReg(DMA_Type * base, uint8_t channel)
{
...
void EDMA_TCDSetNbytes(DMA_Type * base, uint8_t channel, uint32_t nbytes)
{
# 294 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    if (((base->CR & 0x80u) >> 7u) != 0UL)
    {
        
# 296 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
       _Bool 
# 296 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
            mlOffNo = 
# 296 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                      0
# 296 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
        ...
        if (((base->TCD[channel].NBYTES.MLOFFNO & 0x80000000u) >> 31u) == 0UL)
        {
            if (((base->TCD[channel].NBYTES.MLOFFNO & 0x40000000u) >> 30u) == 0UL)
            {
                ...
                mlOffNo = 
# 302 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                         1
# 302 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
                             ;
            }
        }
        if (!mlOffNo)
...
void EDMA_TCDSetMinorLoopOffset(DMA_Type * base, uint8_t channel, int32_t offset)
{
# 344 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    if (((base->CR & 0x80u) >> 7u) != 0UL)
    {
        
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
       _Bool 
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
            mlOffNo = 
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                      0
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
        ...
        {
            mlOffNo = 
# 349 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                     1
# 349 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
                         ;
        }
        if (((base->TCD[channel].NBYTES.MLOFFNO & 0x40000000u) >> 30u) != 0UL)
        {
            mlOffNo = 
# 353 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                     1
# 353 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
                         ;
        }
        if (mlOffNo)
        {
...
void EDMA_TCDSetChannelMinorLink(
                DMA_Type * base, uint8_t channel, uint32_t linkChannel, 
# 386 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c" 3 4
                                                                       _Bool 
# 386 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
                                                                            enable)
{
# 428 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\edma\\edma_hw_access.c"
    uint16_t regValTemp;
