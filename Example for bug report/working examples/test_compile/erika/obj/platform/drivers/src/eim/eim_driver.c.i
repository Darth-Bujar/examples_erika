# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\test_compile\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
# 37 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h" 1
# 23 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h" 1
# 23 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
...
# 24 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h" 2
...
# 25 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h" 2
# 55 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
typedef struct
{
    uint8_t channel;
...
# 66 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h" 3 4
   _Bool 
# 66 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
        enable;

} eim_user_channel_config_t;
# 114 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
void EIM_DRV_Init(uint32_t instance,
                  uint8_t channelCnt,
                  const eim_user_channel_config_t *channelConfigArr);
# 126 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
void EIM_DRV_Deinit(uint32_t instance);
# 149 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
void EIM_DRV_ConfigChannel(uint32_t instance,
                           const eim_user_channel_config_t *userChannelConfig);
# 161 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
void EIM_DRV_GetChannelConfig(uint32_t instance,
                              uint8_t channel,
                              eim_user_channel_config_t *channelConfig);
# 173 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/eim_driver.h"
void EIM_DRV_GetDefaultConfig(uint8_t channel,
                              eim_user_channel_config_t *channelConfig);
# 24 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h" 2
# 59 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
void EIM_InitChannel(EIM_Type * const base);
# 68 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline void EIM_Enable(EIM_Type * const base)
{
    base->EIMCR |= 0x1u;
}
# 80 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline void EIM_Disable(EIM_Type * const base)
{
    base->EIMCR &= ~0x1u;
}
# 96 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline void EIM_EnableChannelCmd(EIM_Type * const base,
                                        uint8_t channel,
                                        
# 98 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h" 3 4
                                       _Bool 
# 98 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
                                            enable)
{
    uint32_t temp;

    temp = base->EICHEN;
    temp &= ~(1UL << ((31U) - channel));
    temp |= (enable ? 1UL : 0UL) << ((31U) - channel);
    base->EICHEN = temp;
}
# 119 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline 
# 119 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h" 3 4
             _Bool 
# 119 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
                  EIM_IsChannelEnabled(const EIM_Type * const base,
                                        uint8_t channel)
{
    return ((base->EICHEN & (1UL << ((31U) - channel))) != 0UL);
}
# 134 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline void EIM_SetCheckBitMask(EIM_Type * const base,
                                       uint8_t channel,
                                       uint8_t checkBitMask)
{
    base->EICHDn[channel].WORD0 = (((uint32_t)(((uint32_t)(checkBitMask))<<25u))&0xFE000000u);
}
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline uint8_t EIM_GetCheckBitMask(const EIM_Type * const base,
                                          uint8_t channel)
{
    return ((uint8_t)((base->EICHDn[channel].WORD0) >> 25u));
}
# 165 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
...
# 201 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_hw_access.h"
static inline uint32_t EIM_GetDataMask(const EIM_Type * const base,
                                       uint8_t channel)
{
    return (base->EICHDn[channel].WORD1);
}
# 38 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c" 2
...
static EIM_Type * const s_eimBase[] = { ((EIM_Type *)(0x40019000u)) };
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
void EIM_DRV_Init(uint32_t instance,
                  uint8_t channelCnt,
                  const eim_user_channel_config_t *channelConfigArr)
{
...
# 92 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
void EIM_DRV_Deinit(uint32_t instance)
{
    ((void)0);
    EIM_Type * base = s_eimBase[instance];
...
# 115 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
void EIM_DRV_ConfigChannel(uint32_t instance,
                           const eim_user_channel_config_t *userChannelConfig)
{
    ((void)0);
    ...
    EIM_EnableChannelCmd(base, userChannelConfig->channel, 
# 124 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c" 3 4
                                                          0
# 124 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
                                                               );
...
# 145 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
void EIM_DRV_GetChannelConfig(uint32_t instance,
                              uint8_t channel,
                              eim_user_channel_config_t *channelConfig)
{
...
# 176 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
void EIM_DRV_GetDefaultConfig(uint8_t channel,
                              eim_user_channel_config_t *channelConfig)
{
    ((void)0);
    ...
    channelConfig->checkBitMask = (0x01U);

    channelConfig->dataMask = (0x00U);
...
# 193 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c" 3 4
                           1
# 193 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\eim\\eim_driver.c"
                               ;
}
