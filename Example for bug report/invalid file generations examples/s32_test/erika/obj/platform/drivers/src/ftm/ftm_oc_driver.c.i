# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
# 25 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_oc_driver.h" 1
# 25 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_oc_driver.h"
...
# 1758 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_common.h"
                                  softwareTrigger);
# 26 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_oc_driver.h" 2
...
# 145 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_oc_driver.h"
                                                softwareTrigger);
# 26 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 2
...
void FTM_DRV_SetChnInputCaptureFilter(FTM_Type * const ftmBase,
                                      uint8_t channel,
                                      uint8_t value);
# 27 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 2
# 42 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
status_t FTM_DRV_InitOutputCompare(uint32_t instance,
                                   const ftm_output_cmp_param_t * param)
{
    ((void)0);
    ...
    if ((
# 55 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
        ((void *)0) 
# 55 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
             != state) && (FTM_MODE_NOT_INITIALIZED == state->ftmMode))
    {
        FTM_DRV_SetClockSource(ftmBase, FTM_CLOCK_SOURCE_NONE);
        FTM_DRV_SetCpwms(ftmBase, 
# 58 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                 0
# 58 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                      );
...
# 64 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                          0
# 64 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                               );
...
# 71 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                                                 0
# 71 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                                                      );
            FTM_DRV_SetDualChnCombineCmd(ftmBase, chnlPairNum, 
# 72 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                                              0
# 72 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                                                   );
            FTM_DRV_SetDualEdgeCaptureCmd(ftmBase, chnlPairNum, 
# 73 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                                               0
# 73 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                                                    );
        ...
        FTM_DRV_SetSoftwareTriggerCmd(ftmBase, 
# 87 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                              1
# 87 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                                  );
...
# 107 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
status_t FTM_DRV_DeinitOutputCompare(uint32_t instance,
                                     const ftm_output_cmp_param_t * param)
{
    ((void)0);
...
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
status_t FTM_DRV_UpdateOutputCompareChannel(uint32_t instance,
                                            uint8_t channel,
                                            uint16_t nextComparematchValue,
                                            ftm_output_compare_update_t update,
                                            
# 154 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c" 3 4
                                           _Bool 
# 154 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_oc_driver.c"
                                                softwareTrigger)
{
    ((void)0);
    ((void)0);
