# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
# 32 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_mc_driver.h" 1
# 25 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_mc_driver.h"
...
# 1758 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_common.h"
                                  softwareTrigger);
# 26 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_mc_driver.h" 2
...
# 33 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c" 2
...
void FTM_DRV_SetChnInputCaptureFilter(FTM_Type * const ftmBase,
                                      uint8_t channel,
                                      uint8_t value);
# 34 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c" 2
# 52 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
status_t FTM_DRV_InitCounter(uint32_t instance,
                             const ftm_timer_param_t * timer)
{
    ((void)0);
    ...
    if ((
# 63 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c" 3 4
        ((void *)0) 
# 63 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
...
# 73 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c" 3 4
                                          0
# 73 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
                                               );
...
# 83 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c" 3 4
                                     0
# 83 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
                                          );
        }
        else if (FTM_MODE_UP_DOWN_TIMER == timer->mode)
        {
            FTM_DRV_SetCpwms(ftmBase, 
# 87 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c" 3 4
                                     1
# 87 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
                                         );
        }
        else
        {
...
# 111 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
status_t FTM_DRV_CounterStart(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
...
# 132 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
status_t FTM_DRV_CounterStop(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
...
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
uint32_t FTM_DRV_CounterRead(uint32_t instance)
{
    ((void)0);
...
# 166 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_mc_driver.c"
void FTM_MC_DRV_GetDefaultConfig(ftm_timer_param_t * const config)
{
    ((void)0);
