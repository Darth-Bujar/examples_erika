# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
# 16 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
...
# 17 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 2
...
# 23 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.h" 2
...
# 18 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 2
...
# 19 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 2
# 53 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
FLEXIO_Type * const g_flexioBase[(1u)] = { ((FLEXIO_Type *)(0x4005A000u)) };


flexio_device_state_t *g_flexioDeviceStatePtr[(1u)] = {
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                                       ((void *)0)
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                                                           };


const IRQn_Type g_flexioIrqId[(1u)] = { FLEXIO_IRQn };


const clock_names_t g_flexioClock[(1u)] = {FLEXIO0_CLK};


const uint8_t g_flexioDMASrc[(1u)][(4U)] =
    {{(uint8_t)EDMA_REQ_FLEXIO_SHIFTER0, (uint8_t)EDMA_REQ_FLEXIO_SHIFTER1,
      (uint8_t)EDMA_REQ_FLEXIO_SHIFTER2_SAI1_RX, (uint8_t)EDMA_REQ_FLEXIO_SHIFTER3_SAI1_TX}};
# 76 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
void FLEXIO_IRQHandler(void);
# 86 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
status_t FLEXIO_DRV_InitDevice(uint32_t instance, flexio_device_state_t *deviceState)
{
    ...
    if (g_flexioDeviceStatePtr[instance] == 
# 92 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                           ((void *)0)
# 92 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                               )
    {
        ...
        FLEXIO_SetEnable(baseAddr, 
# 103 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                  1
# 103 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                      );
        ...
        {
            deviceState->flexioStatePtr[count] = 
# 109 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                ((void *)0)
# 109 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                                    ;
        }
...
# 125 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
status_t FLEXIO_DRV_DeinitDevice(uint32_t instance)
{
    FLEXIO_Type *baseAddr;
    ...
    g_flexioDeviceStatePtr[instance] = 
# 137 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                      ((void *)0)
# 137 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                          ;

    return STATUS_SUCCESS;
}
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
status_t FLEXIO_DRV_Reset(uint32_t instance)
{
    FLEXIO_Type *baseAddr;
...
static status_t FLEXIO_DRV_Allocate(uint32_t instance, flexio_common_state_t *driver)
{
    ...
    (void)OSIF_MutexLock(&(g_flexioDeviceStatePtr[instance]->resourceLock), 0xFFFFFFFFu);
...
# 214 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
...
# 232 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
static void FLEXIO_DRV_ResourcesInit(uint32_t instance, const flexio_common_state_t *driver)
{
    ...
    for (resource = resourceIndex; resource < (resourceIndex + resourceCount); resource++)
    {
        ...
        FLEXIO_SetShifterInterrupt(baseAddr, (uint8_t)(1U << resource), 
# 248 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                                       0
# 248 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                                                            );
        FLEXIO_SetShifterErrorInterrupt(baseAddr, (uint8_t)(1U << resource), 
# 249 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                                            0
# 249 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                                                                 );
        FLEXIO_SetTimerInterrupt(baseAddr, (uint8_t)(1U << resource), 
# 250 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                                     0
# 250 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                                                          );
        FLEXIO_SetShifterDMARequest(baseAddr, (uint8_t)(1U << resource), 
# 251 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                                        0
# 251 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                                                             );
...
# 266 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
status_t FLEXIO_DRV_InitDriver(uint32_t instance, flexio_common_state_t *driver)
{
    uint16_t count;
    status_t retCode;
    ...
    for (count = 0U; count < (4U); count++)
    {
        if (flexioStatePtr[count] == 
# 284 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                    ((void *)0)
# 284 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                        )
        {
    ...
    driver->isr = 
# 298 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                 ((void *)0)
# 298 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                     ;
    driver->instance = instance;

    return STATUS_SUCCESS;
}
# 311 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
status_t FLEXIO_DRV_DeinitDriver(const flexio_common_state_t *driver)
{
    uint16_t count;
    uint32_t instance;
    ...
    for (count = 0U; count < (4U); count++)
    {
        if (flexioStatePtr[count] == driver)
        {
            ...
            flexioStatePtr[count] = 
# 326 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                   ((void *)0)
# 326 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                                       ;
            break;
        }
    }
...
# 346 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
void FLEXIO_IRQHandler(void)
{
    uint16_t count;
    uint32_t instance;
    ...
    for (count = 0U; count < (4U); count++)
    {
        ...
        if ((driverState != 
# 376 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                           ((void *)0)
# 376 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
                               ) && (driverState->isr != 
# 376 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c" 3 4
                                                         ((void *)0)
# 376 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\flexio\\flexio_common.c"
