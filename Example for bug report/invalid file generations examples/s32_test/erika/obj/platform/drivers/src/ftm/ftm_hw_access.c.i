# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
# 36 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.h" 1
# 44 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.h"
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stdbool.h" 1 3 4
# 45 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.h" 2
...
# 47 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.h" 2
...
# 48 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.h" 2
...
void FTM_DRV_SetChnInputCaptureFilter(FTM_Type * const ftmBase,
                                      uint8_t channel,
                                      uint8_t value);
# 37 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c" 2
# 49 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
void FTM_DRV_InitModule(FTM_Type * const ftmBase,
                        ftm_clock_ps_t ftmClockPrescaler)
{

    FTM_DRV_Enable(ftmBase, 
# 53 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c" 3 4
                           1
# 53 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
                               );
...
void FTM_DRV_Reset(FTM_Type * const ftmBase)
{
    ...
    ((ftmBase)->HCR) = 0U;
        ...
        if ((ftmBase == ((FTM_Type *)(0x40039000u))) || (ftmBase == ((FTM_Type *)(0x4003A000u))))
    ...
    for (chnIndex = 0; chnIndex < (8U); chnIndex++)
    {
...
# 128 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
void FTM_DRV_SetChnTriggerCmd(FTM_Type * const ftmBase,
                              uint8_t channel,
                              
# 130 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c" 3 4
                             _Bool 
# 130 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
                                  enable)
{
    ((void)0);
    uint32_t value = 0U;
    ...
    if (channel < 2U)
    {
        value = (uint32_t)0x10u << (uint32_t)channel;
    }
    else if (channel < 6U)
    {
        value = (uint32_t)0x1u << ((uint32_t)(channel) - 2U);
    }
    else
    {
        value = (uint32_t)0x100u << ((uint32_t)(channel) - 6U);
    }

    if (
# 148 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c" 3 4
       1 
# 148 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_hw_access.c"
            == enable)
    {
                                      ...
                                      uint8_t value)
{
    ...
    {
        case (0U):
            (((ftmBase)->FILTER) = ((((ftmBase)->FILTER) & ~(0xFu)) | ((((uint32_t)(((uint32_t)(value))<<0u))&0xFu))));
            break;
        case (1U):
            (((ftmBase)->FILTER) = ((((ftmBase)->FILTER) & ~(0xF0u)) | ((((uint32_t)(((uint32_t)(value))<<4u))&0xF0u))));
            break;
        case (2U):
            (((ftmBase)->FILTER) = ((((ftmBase)->FILTER) & ~(0xF00u)) | ((((uint32_t)(((uint32_t)(value))<<8u))&0xF00u))));
            break;
        case (3U):
            (((ftmBase)->FILTER) = ((((ftmBase)->FILTER) & ~(0xF000u)) | ((((uint32_t)(((uint32_t)(value))<<12u))&0xF000u))));
            break;
        default:
