# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
# 32 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_qd_driver.h" 1
# 25 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_qd_driver.h"
...
# 1758 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_common.h"
                                  softwareTrigger);
# 26 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/ftm_qd_driver.h" 2
...
# 33 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 2
...
void FTM_DRV_SetChnInputCaptureFilter(FTM_Type * const ftmBase,
                                      uint8_t channel,
                                      uint8_t value);
# 34 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 2
# 47 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
status_t FTM_DRV_QuadDecodeStart(uint32_t instance,
                                 const ftm_quad_decode_config_t * config)
{
    ((void)0);
    ...
    if ((
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 3 4
        ((void *)0) 
# 56 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
             != state) && (FTM_MODE_NOT_INITIALIZED == state->ftmMode))
    {

        FTM_DRV_SetQuadDecoderCmd(ftmBase, 
# 59 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 3 4
                                          0
# 59 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
                                               );
        ...
        {
            FTM_DRV_SetChnInputCaptureFilter(ftmBase, (0U), config->phaseAConfig.phaseFilterVal);
        }
        ...
        {
            FTM_DRV_SetChnInputCaptureFilter(ftmBase, (1U), config->phaseBConfig.phaseFilterVal);
        }
        ...
        FTM_DRV_SetQuadDecoderCmd(ftmBase, 
# 88 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 3 4
                                          1
# 88 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
                                              );
...
# 106 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
status_t FTM_DRV_QuadDecodeStop(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
    ...
    FTM_DRV_SetQuadDecoderCmd(ftmBase, 
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 3 4
                                      0
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
                                           );
    state->ftmMode = FTM_MODE_NOT_INITIALIZED;

    return STATUS_SUCCESS;
}
# 128 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
ftm_quad_decoder_state_t FTM_DRV_QuadGetState(uint32_t instance)
{
    ((void)0);
...
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
void FTM_QD_DRV_GetDefaultConfig(ftm_quad_decode_config_t * const config)
{
    ((void)0);
...
# 157 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 3 4
                                           0
# 157 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
                                                ;
...
# 160 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c" 3 4
                                           0
# 160 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\ftm\\ftm_qd_driver.c"
                                                ;
