# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
# 39 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
...
# 40 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 2
# 50 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
void LPUART_Init(LPUART_Type * base)
{
    ...
    base->FIFO = (0x0003C000U);

    base->WATER = 0x00000000;

}
# 81 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
void LPUART_SetBitCountPerChar(LPUART_Type * base, lpuart_bit_count_per_char_t bitCountPerChar, 
# 81 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
                                                                                               _Bool 
# 81 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
                                                                                                    parity)
{
    ...
    else
    {
        ...
        base->CTRL = (base->CTRL & ~0x10u) | (tmpBitCountPerChar << 4u);

        base->BAUD &= ~0x20000000u;
    }
}
# 110 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
void LPUART_SetParityMode(LPUART_Type * base, lpuart_parity_mode_t parityModeType)
{
...
void LPUART_SetIntMode(LPUART_Type * base, lpuart_interrupt_t intSrc, 
# 200 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
                                                                     _Bool 
# 200 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
                                                                          enable)
{
...
# 235 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
_Bool 
# 235 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
    LPUART_GetIntMode(const LPUART_Type * base, lpuart_interrupt_t intSrc)
{
    uint32_t reg = (uint32_t)(intSrc) >> (16U);
    
# 238 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
   _Bool 
# 238 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
        retVal = 
# 238 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
                 0
# 238 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
...
# 271 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
_Bool 
# 271 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
    LPUART_GetStatusFlag(const LPUART_Type * base, lpuart_status_flag_t statusFlag)
{
    uint32_t reg = (uint32_t)(statusFlag) >> (16U);
    
# 274 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
   _Bool 
# 274 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
        retVal = 
# 274 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
                 0
# 274 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
...
void LPUART_SetErrorInterrupts(LPUART_Type * base, 
# 385 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c" 3 4
                                                  _Bool 
# 385 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\lpuart\\lpuart_hw_access.c"
                                                       enable)
{
