# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.c"
# 24 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.c"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.h" 1
# 42 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.h"
...
# 43 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.h" 2
# 1 "c:\\program files (x86)\\gnu arm embedded toolchain\\10 2021.10\\lib\\gcc\\arm-none-eabi\\10.3.1\\include\\stdbool.h" 1 3 4
# 44 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.h" 2
...
# 45 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.h" 2
...
# 46 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.h" 2
...
# 25 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.c" 2
# 50 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.c"
 void CMP_SetFunctionalMode(CMP_Type* baseAddr, cmp_mode_t mode, uint8_t filter_sample_count, uint8_t filter_sample_period)
 {
    uint32_t tmp = baseAddr->C0;
    tmp = tmp & ( ~(0x8000u & 0xFF0000u & 0x70u & 0x100u & 0x4000u));
    baseAddr->C0 = tmp;
        switch(mode)
        {
        case CMP_DISABLED:
            break;
        case CMP_CONTINUOUS:
            tmp |= (((uint32_t)(((uint32_t)(1U))<<8u))&0x100u);
            break;
        case CMP_SAMPLED_NONFILTRED_EXT_CLK:
            tmp |= (((uint32_t)(((uint32_t)(1U))<<8u))&0x100u);
            tmp |= (((uint32_t)(((uint32_t)(1U))<<15u))&0x8000u);
            tmp |= (((uint32_t)(((uint32_t)(1U))<<4u))&0x70u);
            tmp |= (((uint32_t)(((uint32_t)(filter_sample_period))<<16u))&0xFF0000u);
            break;
        ...
        case CMP_SAMPLED_FILTRED_INT_CLK:
            tmp |= (((uint32_t)(((uint32_t)(1U))<<8u))&0x100u);
            tmp |= (((uint32_t)(((uint32_t)(filter_sample_count))<<4u))&0x70u);
            tmp |= (((uint32_t)(((uint32_t)(filter_sample_period))<<16u))&0xFF0000u);
            break;
        ...
        case CMP_WINDOWED:
            tmp |= (((uint32_t)(((uint32_t)(1U))<<8u))&0x100u);
            tmp |= (((uint32_t)(((uint32_t)(1U))<<14u))&0x4000u);
            tmp |= (((uint32_t)(((uint32_t)(0U))<<4u))&0x70u);
            break;
...
# 116 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\cmp\\cmp_hw_access.c"
 cmp_mode_t CMP_GetFunctionalMode(const CMP_Type* baseAddr)
{
    uint32_t state;
    uint32_t tmp = baseAddr->C0;
    cmp_mode_t mode = CMP_DISABLED;
    state = (((baseAddr->C0) & 0x100u) >> 8u) << 2U;
    state |= (((baseAddr->C0) & 0x4000u) >> 14u) << 1U;
    state |= (((baseAddr->C0) & 0x8000u) >> 15u);
    uint32_t filter_sample_period = (tmp & 0xFF0000u) >> 16u;
    uint32_t filter_sample_count = (tmp & 0x70u) >> 4u;
