# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
# 35 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
...
# 36 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c" 2
...
# 37 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c" 2
...
# 103 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_hw_access.h"
    TRGMUX_GetLockForTargetModule(const TRGMUX_Type * const base,
                                   const trgmux_target_module_t targetModule);
# 38 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c" 2
...
static TRGMUX_Type * const s_trgmuxBase[(1u)] = { ((TRGMUX_Type *)(0x40063000u)) };
# 71 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
status_t TRGMUX_DRV_Init(const uint32_t instance,
                         const trgmux_user_config_t * const trgmuxUserConfig)
{
    ((void)0);
...
# 114 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
status_t TRGMUX_DRV_Deinit(const uint32_t instance)
{
    ((void)0);
...
# 135 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
status_t TRGMUX_DRV_SetTrigSourceForTargetModule(const uint32_t instance,
                                                 const trgmux_trigger_source_t triggerSource,
                                                 const trgmux_target_module_t targetModule)
{
...
# 143 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c" 3 4
   _Bool 
# 143 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
        lock;

    lock = TRGMUX_GetLockForTargetModule(base, targetModule);

    if (lock == 
# 147 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c" 3 4
               1
# 147 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
                   )
    {
        status = STATUS_ERROR;
    }
...
# 168 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
trgmux_trigger_source_t TRGMUX_DRV_GetTrigSourceForTargetModule(const uint32_t instance,
                                                                const trgmux_target_module_t targetModule)
{
    ((void)0);
...
# 185 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
void TRGMUX_DRV_SetLockForTargetModule(const uint32_t instance,
                                       const trgmux_target_module_t targetModule)
{
    ((void)0);
...
# 203 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"

# 203 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c" 3 4
_Bool 
# 203 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
    TRGMUX_DRV_GetLockForTargetModule(const uint32_t instance,
                                       const trgmux_target_module_t targetModule)
...
# 221 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\trgmux\\trgmux_driver.c"
void TRGMUX_DRV_GenSWTrigger(const uint32_t instance)
{
    ((void)0);
 (void)instance;

 static SIM_Type * const s_simBase[(1u)] = { ((SIM_Type *)(0x40048000u)) };


 s_simBase[0U]->MISCTRL1 = 0U;
 s_simBase[0U]->MISCTRL1 = (((uint32_t)(((uint32_t)(1U))<<0u))&0x1u);
}
