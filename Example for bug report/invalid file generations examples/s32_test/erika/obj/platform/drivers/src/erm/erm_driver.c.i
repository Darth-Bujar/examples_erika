# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
# 34 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
...
# 35 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c" 2
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h" 1
# 21 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
# 1 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h" 1
# 21 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
...
# 22 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h" 2
...
# 23 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h" 2
# 42 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
typedef enum
{
    ERM_EVENT_NONE = 0U,
...
# 55 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h" 3 4
   _Bool 
# 55 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
        enableSingleCorrection;
    
# 56 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h" 3 4
   _Bool 
# 56 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
...
# 91 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
void ERM_DRV_Init(uint32_t instance,
                  uint8_t channelCnt,
                  const erm_user_config_t * userConfigArr);
# 102 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
void ERM_DRV_Deinit(uint32_t instance);
# 113 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
void ERM_DRV_SetInterruptConfig(uint32_t instance,
                                uint8_t channel,
                                erm_interrupt_config_t interruptCfg);
# 127 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
void ERM_DRV_GetInterruptConfig(uint32_t instance,
                                uint8_t channel,
                                erm_interrupt_config_t * const interruptPtr);
# 141 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
void ERM_DRV_ClearEvent(uint32_t instance,
                        uint8_t channel,
                        erm_ecc_event_t eccEvent);
# 155 "C:\\NXP\\S32_SD~1.3/platform/drivers/inc/erm_driver.h"
erm_ecc_event_t ERM_DRV_GetErrorDetail(uint32_t instance,
                                       uint8_t channel,
                                       uint32_t * addressPtr);
# 22 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h" 2
# 60 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
void ERM_Init(ERM_Type * const base);
# 74 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
static inline void ERM_EnableEventInterrupt(ERM_Type * const base,
                                            uint8_t channel,
                                            erm_ecc_event_t eccEvent,
                                            
# 77 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h" 3 4
                                           _Bool 
# 77 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
                                                enable)
{
    ...
    if (eccEvent == ERM_EVENT_SINGLE_BIT)
    {
        if (enable)
        {
            tempCtrl |= 0x80000000u >> (channel * (4U));
        }
        else
        {
            tempCtrl &= ~(0x80000000u >> (channel * (4U)));
    ...
    else if (eccEvent == ERM_EVENT_NON_CORRECTABLE)
    {
        if (enable)
        {
            tempCtrl |= 0x40000000u >> (channel * (4U));
        }
        else
        {
            tempCtrl &= ~(0x40000000u >> (channel * (4U)));
...
# 126 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
static inline 
# 126 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h" 3 4
             _Bool 
# 126 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
                  ERM_IsEventInterruptEnabled(const ERM_Type * const base,
                                               uint8_t channel,
                                               erm_ecc_event_t eccEvent)
{
    uint32_t retVal = 0U;
    ...
    if (eccEvent == ERM_EVENT_SINGLE_BIT)
    {
        retVal = base->CR0 & (0x80000000u >> (channel * (4U)));
    }

    else if (eccEvent == ERM_EVENT_NON_CORRECTABLE)
    {
        retVal = base->CR0 & (0x40000000u >> (channel * (4U)));
    }
    else
    {
...
# 162 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
static inline 
# 162 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h" 3 4
             _Bool 
# 162 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
                  ERM_IsEventDetected(const ERM_Type * const base,
                                       uint8_t channel,
                                       erm_ecc_event_t eccEvent)
{
    uint32_t retVal = 0U;
    ...
    if (eccEvent == ERM_EVENT_SINGLE_BIT)
    {
        retVal = base->SR0 & (0x80000000u >> (channel * (4U)));
    }

    else if (eccEvent == ERM_EVENT_NON_CORRECTABLE)
    {
        retVal = base->SR0 & (0x40000000u >> (channel * (4U)));
    }
    else
    {
...
# 194 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
static inline void ERM_ClearEventSingle(ERM_Type * const base,
                                        uint8_t channel)
{
    base->SR0 = 0x80000000u >> (channel * (4U));
...
# 213 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
static inline void ERM_ClearEventDouble(ERM_Type * const base,
                                        uint8_t channel)
{
    base->SR0 = 0x40000000u >> (channel * (4U));
...
# 233 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_hw_access.h"
...
# 36 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c" 2





static ERM_Type * const s_ermBase[] = { ((ERM_Type *)(0x40018000u)) };
# 54 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
void ERM_DRV_Init(uint32_t instance,
                  uint8_t channelCnt,
                  const erm_user_config_t * userConfigArr)
{
...
# 82 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
void ERM_DRV_Deinit(uint32_t instance)
{
    ((void)0);
    ERM_Type * base = s_ermBase[instance];
...
# 99 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
void ERM_DRV_SetInterruptConfig(uint32_t instance,
                                uint8_t channel,
                                erm_interrupt_config_t interruptCfg)
{
...
# 120 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
void ERM_DRV_GetInterruptConfig(uint32_t instance,
                                uint8_t channel,
                                erm_interrupt_config_t * const interruptPtr)
{
...
# 142 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
void ERM_DRV_ClearEvent(uint32_t instance,
                        uint8_t channel,
                        erm_ecc_event_t eccEvent)
{
...
# 174 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
erm_ecc_event_t ERM_DRV_GetErrorDetail(uint32_t instance,
                                       uint8_t channel,
                                       uint32_t * addressPtr)
{
    ...
    if (ERM_IsEventDetected(base, channel, ERM_EVENT_SINGLE_BIT) != 
# 185 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c" 3 4
                                                                   0
# 185 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
                                                                        )
    {
        eccEvent = ERM_EVENT_SINGLE_BIT;
    }

    else if (ERM_IsEventDetected(base, channel, ERM_EVENT_NON_CORRECTABLE) != 
# 190 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c" 3 4
                                                                             0
# 190 "C:\\NXP\\S32_SD~1.3\\platform\\drivers\\src\\erm\\erm_driver.c"
                                                                                  )
    {
