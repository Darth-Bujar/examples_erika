# 1 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
# 1 "D:\\RTOS_PROJEKT\\erica\\workspace\\s32_test\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
# 60 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
...
# 61 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c" 2
...
# 62 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c" 2
...
# 79 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
void SystemInit(void)
{
# 100 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
...
# 131 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
    ((MPU_Type *)(0x4000D000u))->RGDAAC[0] |= ( (((uint32_t)(((uint32_t)(3))<<21u))&0x600000u)
                      | (((uint32_t)(((uint32_t)(7))<<18u))&0x1C0000u) );

}
# 145 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
void SystemCoreClockUpdate(void)
{
...
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c" 3 4
 _Bool 
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
      validSystemClockSource = 
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c" 3 4
                               1
# 150 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
                                   ;
  ...
  switch ((((SCG_Type *)(0x40064000u))->CSR & 0xF000000u) >> 24u) {
   ...
   if (regValue != 0U)
    ...
    default:
      validSystemClockSource = 
# 185 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c" 3 4
                              0
# 185 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
                                   ;
      break;
  }

  if (validSystemClockSource == 
# 189 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c" 3 4
                               1
# 189 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
                                   ) {
     SystemCoreClock = (SCGOUTClock / divider);
  }
}
# 201 "C:\\NXP\\S32_SD~1.3\\platform\\devices\\S32K148\\startup\\system_S32K148.c"
void SystemSoftwareReset(void)
{
    uint32_t regValue;
